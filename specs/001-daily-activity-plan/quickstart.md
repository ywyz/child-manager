...
为 `in_progress` 并覆盖 T087–T126；固定文档基线、T087–T097 RED 与 T098–T104 已完成。
T104 完成提交为 `dev@a75e05576f8dfae98b199ea3411f29bc7f76466a`，自有门禁为
`10 passed`；当前下一项为 T105。批量/单栏受理、任务轮询和预览生命周期薄路由验收保留给
T107。下列命令覆盖 M1～M8 验收合同，尚未完成的用户故事步骤不可执行，也不表示已经通过。
