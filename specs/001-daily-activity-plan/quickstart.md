...
M6 [Issue #11](https://github.com/ywyz/child-manager/issues/11) 已完成并覆盖 T087–T126；
...
`main@5cd6186a5fc6d291e0d1f0220f2f989d8c77b77f`。下列命令覆盖 M1～M8 验收合同，已完成的用户故事步骤仍需以固定证据复核。
