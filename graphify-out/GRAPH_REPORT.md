...
## Summary
- 601 nodes · 543 edges · 160 communities (63 shown, 97 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f1245509`
...
5. `Child Manager 项目上下文` - 15 edges
6. `Child Manager 幼儿园教育管理系统` - 14 edges
7. `daily_activity_plans 表` - 12 edges
...
### Community 0 - "daily_activity_plans 表"
Cohesion: 0.07
Nodes (41): age_groups 表, ai_generation_results 表, ai_model_profile_capabilities 表, ai_model_profiles 表, AI 档案启用不变量, AI 结果追溯与内容清理, 教案变更原子事务, audit_events 表 (+33 more)
...
### Community 3 - "Child Manager 幼儿园教育管理系统"
Cohesion: 0.09
...
### Community 6 - "ADR-0003：PostgreSQL 保存任务权威状态，Dramatiq 与 Redis 负责异步执行"
Cohesion: 0.14
...
### Community 7 - "Child Manager 数据模型设计"
Cohesion: 0.14
...
### Community 11 - "ADR-0004：采用同源入口、HttpOnly Cookie 与 API 统一授权"
Cohesion: 0.17
...
### Community 52 - "7. AI 模型档案"
Cohesion: 0.67
Nodes (3): 7.1 `ai_model_profiles`, 7.2 `ai_model_profile_capabilities`, 7. AI 模型档案

### Community 53 - "应用事务不变量"
Cohesion: 0.67
Nodes (3): 应用事务不变量, 不使用业务触发器, 应用用例拥有事务

### Community 54 - "园所组合外键隔离"
Cohesion: 0.67
Nodes (3): 组合外键矩阵, 跨园关联拒绝测试, 园所组合外键隔离

### Community 55 - "11. Word 与文件架构"
Cohesion: 0.67
Nodes (3): 11.1 导出流程, 11.2 上传 `.docx`, 11. Word 与文件架构

### Community 56 - "13. 配置、密钥与安全"
Cohesion: 0.67
Nodes (3): 13.1 配置分级, 13.2 安全边界, 13. 配置、密钥与安全

### Community 57 - "15. 生产部署延后边界"
Cohesion: 0.67
...
### Community 59 - "7. API 与契约"
Cohesion: 0.67
Nodes (3): 7.1 API 原则, 7.2 跨进程任务契约, 7. API 与契约

### Community 60 - "15. 安全、隐私与审计"
Cohesion: 0.67
...
## Knowledge Gaps
- **434 isolated node(s):** `1. 事实来源与冲突处理`, `2.1 先理解再编码`, `2.2 保持最小实现`, `2.3 先定义完成标准`, `3. 精准修改` (+429 more)
...
- **Why does `教案管理 PRD（首期：一日活动计划）` connect `教案管理 PRD（首期：一日活动计划）` to `14. Word 导出`, `17. 非功能要求`, `README.md`, `18. 验收标准`, `5. 用户与权限`, `8. 核心业务对象`, `10. 教案栏目与格式`, `13. AI 生成流程`, `12. AI 模型与提示词管理`, `7. 首期必要设置`, `9. 日期与上下文规则`, `15. 安全、隐私与审计`, `4. 产品目标`, `6. 首期范围`, `11. 计划管理流程`?**
  _High betweenness centrality (0.166) - this node is a cross-community bridge._
- **Why does `Child Manager 数据模型设计` connect `Child Manager 数据模型设计` to `README.md`, `15. 数据快照边界`, `22. 后续扩展边界`, `2. 设计来源与旧系统取舍`, `8. 提示词模型`, `11. 后台任务与 AI 结果`, `16. 外键与删除行为`, `3. 总体建模原则`, `4. 模型总览`, `5. 园所与身份模型`, `6. 教学设置模型`, `7. AI 模型档案`, `9. 一日活动计划模型`, `21. 测试与验收`?**
  _High betweenness centrality (0.151) - this node is a cross-community bridge._
- **Why does `Child Manager 系统架构设计` connect `Child Manager 系统架构设计` to `README.md`, `10. AI 与提示词架构`, `6. 请求、认证与授权`, `9. 后台任务架构`, `11. Word 与文件架构`, `13. 配置、密钥与安全`, `15. 生产部署延后边界`, `4. 架构总览`, `7. API 与契约`, `5. 代码组织与依赖方向`, `8. 数据架构`?**
...
- **Should `daily_activity_plans 表` be split into smaller, more focused modules?**
