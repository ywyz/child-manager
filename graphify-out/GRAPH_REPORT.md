...
- [[_COMMUNITY_FR 异步 AI、预览与采用主题|FR 异步 AI、预览与采用主题]]
- [[_COMMUNITY_FR 安全、审计与降级主题|FR 安全、审计与降级主题]]
- [[_COMMUNITY_FR 集体活动导入与部分成功主题|FR 集体活动导入与部分成功主题]]
- [[_COMMUNITY_FR 身份、认证与班级授权主题|FR 身份、认证与班级授权主题]]
- [[_COMMUNITY_FR 手工教案、周次与快照主题|FR 手工教案、周次与快照主题]]
- [[_COMMUNITY_FR 模型档案与提示词主题|FR 模型档案与提示词主题]]
- [[_COMMUNITY_FR 首期必要设置主题|FR 首期必要设置主题]]
- [[_COMMUNITY_FR 固定 Word 导出主题|FR 固定 Word 导出主题]]
- [[_COMMUNITY_首期一日活动计划完整闭环 Feature Specification|首期一日活动计划完整闭环 Feature Specification]]
- [[_COMMUNITY_SC AI 教师控制成果|SC AI 教师控制成果]]
- [[_COMMUNITY_SC 性能与可访问性成果|SC 性能与可访问性成果]]
- [[_COMMUNITY_SC 幂等、并发与任务恢复成果|SC 幂等、并发与任务恢复成果]]
- [[_COMMUNITY_SC 权限与敏感信息成果|SC 权限与敏感信息成果]]
- [[_COMMUNITY_SC Word 保真成果|SC Word 保真成果]]
- [[_COMMUNITY_US1 安全初始化与必要设置|US1 安全初始化与必要设置]]
- [[_COMMUNITY_US2 纯手工教案闭环|US2 纯手工教案闭环]]
- [[_COMMUNITY_US3 模型与提示词管理|US3 模型与提示词管理]]
- [[_COMMUNITY_US4 栏目级 AI 与教师决定权|US4 栏目级 AI 与教师决定权]]
...
- [[_COMMUNITY_Phase 3 US1 T021–T041|Phase 3 US1 T021–T041]]
- [[_COMMUNITY_Phase 4 US2 T042–T057|Phase 4 US2 T042–T057]]
- [[_COMMUNITY_Phase 5 US3 T058–T082|Phase 5 US3 T058–T082]]
- [[_COMMUNITY_Phase 6 US4 T083–T106|Phase 6 US4 T083–T106]]
- [[_COMMUNITY_Phase 7 US5 T107–T122|Phase 7 US5 T107–T122]]
- [[_COMMUNITY_Phase 8 US6 T123–T137|Phase 8 US6 T123–T137]]
- [[_COMMUNITY_Phase 9 US7 T138–T154|Phase 9 US7 T138–T154]]
...
- `状态：已被 ADR-0009 取代` --superseded_by--> `ADR-0009：功能完成前延后生产部署与访问网络决策`  [EXTRACTED]
  docs/ADR/ADR-0007-caddy-compose-and-file-secrets.md → docs/ADR/ADR-0009-defer-production-deployment-until-feature-complete.md
...
- **Cloud-only 产品与部署治理边界** — docs_adr_0001_cloud_only_decision_record, agents_kindergarten_scoped_repository, agents_production_deployment_deferred, docs_adr_adr_0009_defer_production_deployment_until_feature_complete_decision_record [EXTRACTED 1.00]
- **AI 预览与教师最终控制** — agents_ai_preview_explicit_adoption, docs_prd_lesson_management_preview_validity_by_actual_inputs, docs_prd_lesson_management_ai_retry_taxonomy, docs_adr_adr_0005_provider_neutral_ai_and_central_prompts_decision_record [EXTRACTED 1.00]
- **M0 到 M9 里程碑门禁链** — docs_roadmap_m0_shared_design_baseline, docs_roadmap_m1_engineering_foundation, docs_roadmap_m2_authentication_authorization, docs_roadmap_m3_required_settings, docs_roadmap_m4_ai_prompt_foundation, docs_roadmap_m5_manual_plan_loop, docs_roadmap_m6_async_ai_generation, docs_roadmap_m7_fixed_word_export, docs_roadmap_m8_feature_acceptance, docs_roadmap_m9_production_review [EXTRACTED 1.00]
- **教案任务预览快照导出持久化链路** — docs_design_data_model_daily_activity_plans, docs_design_data_model_background_jobs, docs_design_data_model_ai_generation_results, docs_design_data_model_daily_activity_plan_snapshots, docs_design_data_model_daily_activity_plan_exports [EXTRACTED 1.00]
