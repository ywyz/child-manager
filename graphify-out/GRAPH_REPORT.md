...
## Summary
- 5234 nodes · 14971 edges · 319 communities (267 shown, 52 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 1437 edges (avg confidence: 0.58)
- Token cost: 19,507 input · 22,459 output

## Graph Freshness
- Built from commit: `e2ee14a9`
- Run `git rev-parse HEAD` and compare to check if the graph is stale.
- Run `graphify update .` after code changes (no API cost).

## Community Hubs (Navigation)
- AI Key & Model Service
- Workday Calendar Client
- Docx Text Extraction
- Bootstrap Startup Service
- AI Generation Results Persistence
- System Architecture & Dependencies
- AI Jobs API Router
- Backup Credential Repository
- Identity Service & Invitations
- API & Web Application Modules
- Daily Plan Export Service
- Worker AI Job Actors
- AI Retry & Audit Events
- Settings & AI Model Profiles
- Prompt Template Renderer
- Authentication API Routes
- AI Runtime Adapter
- AI Audit Event Tests
- Branch Strategy & Issues
- Database Models & Migrations
- Desktop Task Observability
- AI Preview Repositories
- Identity Contract Models
- AI Schema Migrations
- Password & Secret Encryption
- Development Rules & Tooling
- Lesson Plan Editing Service
- AI Prompt Schemas
- AI Preview Adoption Service
- Feature Requirements & Contracts
- AI Job Runner
- WebAuthn Authentication Tests
- Provider-Neutral AI Client
- Architecture Audit & Consistency
- AI Key Encryption & Rotation
- Settings Service Transactions
- Database Domain Tables
- Prompt Test Worker State
- Daily Plan Workspace
- Export API Routes
- AI Generation Coordinator
- Desktop Plan UI Pages
- Word Export Flow Tests
- WebAuthn Challenge Handling
- Spec Kit Skills
- AI Job Creation
- Web BFF API Requests
- Tenant Schema Migration Tests
- Prompt Test Worker Tests
- One-Time Secret Tokens
- Batch Job Query Aggregation
- AI Settings Repository
- User Management Routes
- Word Export Storage
- AI Client Contract Tests
- Prompt API Routes
- Web Plan & Export Requests
- Daily Plan Editor Page
- Word Export Job Store
- AI Batch Generation Tests
- Admin Initialization CLI
- Architecture Decision Records
- Lesson Plan Completeness Rules
...
- First-Run Plan Flow Tests
- AI Result Repository
- Export API Tests
- Plan Permission Tests
- Alembic Database Migrations
- AI Job Dispatcher & Recovery
- Desktop Main Window
...
- Passkey Identity Isolation Tests
...
- Lesson Plan Domain
- Group Activity Source Tests
- Local Development Profiles
- Architecture Boundary Tests
- Workday Service Tests
- AI Adoption Service Tests
...
- Acceptance Verification Iteration
- Offline Windows Acceptance
- First Launch Acceptance
- AI Domain Models
- AI Credentials Boundary
- AI Client Prompts
...
- **AI preview lifecycle coordination tests** — tests_desktop_test_cancel_and_close_discard_late_results, tests_desktop_test_page_change_invalidates_epoch_and_discards_late_signal, tests_desktop_test_reject_changes_only_preview_and_stale_target_cannot_be_adopted, tests_desktop_test_stale_preview_is_invalidated_without_snapshot_or_content_write, tests_desktop_test_adoption_snapshots_before_mutating_current_content, desktop_repository, concept_ai_preview_lifecycle [INFERRED 0.80]
- **Desktop AI migration protection flow** — 0001_desktop_initial_migration, 0002_desktop_ai_migration, desktop_upgrade_database, desktop_bootstrap_service, migration_protective_backup_failed, startup_backup_failed, ai_configuration_table, prompt_overrides_table, ai_previews_table [INFERRED 0.80]
- **Graphify community naming fallback flow** — graphify_tool, graphify_openai_backend, deepseek_model, desktop_luna_worker [INFERRED 0.75]
...
### Community 0 - "AI Key & Model Service"
Cohesion: 0.05
...
### Community 3 - "Bootstrap Startup Service"
Cohesion: 0.05
Nodes (68): Engine, BootstrapService, RuntimeError, StartupError, StartupState, _apply_sqlite_pragmas(), connect_sqlite(), create_session_factory() (+60 more)

### Community 4 - "AI Generation Results Persistence"
Cohesion: 0.07
...
### Community 5 - "System Architecture & Dependencies"
Cohesion: 0.05
Nodes (86): AI 生成与提示词规则 (graphify 源节点), apps/api FastAPI API, apps/web NiceGUI Web + BFF, apps/worker Dramatiq Worker, BFF 服务端转发层 (Backend for Frontend), chinesecalendar (本地工作日库), cryptography (AES-GCM/Argon2id), Dramatiq 2 + Redis (+78 more)

### Community 6 - "AI Jobs API Router"
Cohesion: 0.07
Nodes (82): AiAdoptionServiceDependency, AiGenerationServiceDependency, AiRetryServiceDependency, adopt_ai_preview(), get_ai_preview(), get_job(), alias, CurrentSessionDependency (+74 more)

### Community 7 - "Backup Credential Repository"
Cohesion: 0.06
...
### Community 8 - "Identity Service & Invitations"
Cohesion: 0.12
Nodes (21): AuditRepository, ChallengePurpose, StrEnum, InvitationRecord, _challenge_digest(), _client_challenge(), _decode_base64url(), IdentityError (+13 more)

### Community 9 - "API & Web Application Modules"
Cohesion: 0.05
...
### Community 10 - "Daily Plan Export Service"
Cohesion: 0.10
...
### Community 11 - "Worker AI Job Actors"
Cohesion: 0.08
...
### Community 12 - "AI Retry & Audit Events"
Cohesion: 0.06
Nodes (45): ai_retry_service(), reflection_generation_service(), append_ai_event(), Any, UUID, UUID, AiRetryService, _native_url() (+37 more)

### Community 13 - "Settings & AI Model Profiles"
Cohesion: 0.10
...
### Community 14 - "Prompt Template Renderer"
Cohesion: 0.11
...
### Community 15 - "Authentication API Routes"
Cohesion: 0.16
...
### Community 16 - "AI Runtime Adapter"
Cohesion: 0.07
Nodes (34): ProgressReporter, ProviderNeutralAiClient, _AiRuntimeAdapter, _BatchOutcome, create_desktop_window(), _DesktopServiceFacade, _now_utc_ms(), Any (+26 more)

### Community 17 - "AI Audit Event Tests"
Cohesion: 0.11
Nodes (27): admin_client(), passkey_client(), MonkeyPatch, TestClient, 通过 FastAPI 身份依赖注入建立已 step-up 管理员，不借用密码登录。, _event(), TestClient, test_ai_audit_event_codes_cover_creation_retries_result_reject_and_adopt() (+19 more)

### Community 18 - "Branch Strategy & Issues"
Cohesion: 0.08
Nodes (53): codex 分支 (历史双实现线), dev 分支 (唯一实现与集成), docs 分支 (文档与契约), main 分支 (稳定发布基线), trae 分支 (历史双实现线), Codex Agent, Dev 本地档位 (端口/Compose/数据库隔离), graphify 知识图谱工具与 graphify-out 输出 (+45 more)

### Community 19 - "Database Models & Migrations"
Cohesion: 0.09
...
### Community 20 - "Desktop Task Observability"
Cohesion: 0.08
Nodes (33): BackgroundTask, Event, QObject, QRunnable, ErrorCode, OperationAccepted, StrEnum, TaskProgress (+25 more)

### Community 21 - "AI Preview Repositories"
Cohesion: 0.09
Nodes (22): CursorResult, DatabaseSource, ClassContext, PlanExportRecord, SetupContextRecord, AiAdoptionRecord, AiConfigurationRecord, AiPreviewRecord (+14 more)
...
### Community 23 - "AI Schema Migrations"
Cohesion: 0.08
Nodes (50): 0001_desktop_initial.py (Alembic migration), 0002_desktop_ai.py (Alembic migration), ai_configuration table, ai_previews table, Alembic, AI preview lifecycle (generate/preview/adopt/invalidate), Graphify community naming flow, Credential isolation (+42 more)

### Community 24 - "Password & Secret Encryption"
Cohesion: 0.07
Nodes (46): hash_password(), password_needs_rehash(), password_violations(), Path, verify_password(), _weak_passwords(), _aad(), decrypt_totp_secret() (+38 more)

### Community 25 - "Development Rules & Tooling"
Cohesion: 0.13
...
### Community 26 - "Lesson Plan Editing Service"
Cohesion: 0.10
...
### Community 27 - "AI Prompt Schemas"
Cohesion: 0.28
...
### Community 28 - "AI Preview Adoption Service"
Cohesion: 0.10
Nodes (26): ai_adoption_service(), AiAdoptionService, _native_url(), AiTaskCode, Any, datetime, JsonValue, LessonPlanRepository (+18 more)

### Community 29 - "Feature Requirements & Contracts"
Cohesion: 0.10
Nodes (44): codex 实现分支（待授权创建）, main 分支（docs-only 基线）, trae 实现分支（待授权创建）, AI 生成与提示词规则, 班级与教师配置, 一日活动计划, 日期选择与校验, 教案结构化 (+36 more)

### Community 30 - "AI Job Runner"
Cohesion: 0.11
Nodes (18): AiExecutionContext, AiJobAuthorizer, AiJobStore, AiJobStoreProtocol, _log_sanitized_exception(), Any, datetime, Exception (+10 more)

### Community 31 - "WebAuthn Authentication Tests"
Cohesion: 0.11
Nodes (45): WebAuthn 3.x options 生成与严格注册、认证验证。, csrf_headers(), _base64url(), _credential(), MonkeyPatch, TestClient, _registration_credential(), test_authentication_options_are_username_less_and_browser_ready() (+37 more)

### Community 32 - "Provider-Neutral AI Client"
Cohesion: 0.09
Nodes (28): _pinned_url(), Any, OpenAI 兼容、禁止重定向且错误脱敏的供应商中立客户端。, AiClientError, RuntimeError, _addresses(), AiUrlPolicyError, Resolver (+20 more)

### Community 33 - "Architecture Audit & Consistency"
Cohesion: 0.12
Nodes (41): CSRF & Origin Verification, Data Model Design, Database Schema Design, System Architecture, Combined Audit Conclusion (Q1–Q26), M0-G1 Model & Contract Alignment, M0-G2 Template Instructions Alignment, M0-G3 Template Desensitization & Hash (+33 more)

### Community 34 - "AI Key Encryption & Rotation"
Cohesion: 0.15
...
### Community 35 - "Settings Service Transactions"
Cohesion: 0.09
...
### Community 36 - "Database Domain Tables"
Cohesion: 0.08
...
### Community 37 - "Prompt Test Worker State"
Cohesion: 0.10
...
### Community 38 - "Daily Plan Workspace"
Cohesion: 0.09
Nodes (21): DailyPlanWorkspace, _filename_part(), Any, date, LessonPlanService, Path, Protocol, RuntimeError (+13 more)

### Community 39 - "Export API Routes"
Cohesion: 0.13
Nodes (34): _accepted(), create_export(), download_export(), _export(), get_export(), _job(), list_exports(), alias (+26 more)

### Community 40 - "AI Generation Coordinator"
Cohesion: 0.11
Nodes (16): _AdoptedContent, AiGenerationCoordinator, AiGenerationError, _canonical_json(), CommandResult, CoordinatorState, FrozenGenerationInput, GenerationRuntime (+8 more)

### Community 41 - "Desktop Plan UI Pages"
Cohesion: 0.12
Nodes (16): QDateEdit, BaseException, user_error_message(), _setup_complete(), Slice 1 结构化一日活动计划编辑页。, build_first_run_daily_plan_window(), build_first_run_page(), QWidget (+8 more)

### Community 42 - "Word Export Flow Tests"
Cohesion: 0.13
...
### Community 43 - "WebAuthn Challenge Handling"
Cohesion: 0.10
Nodes (32): ChallengeBinding, ChallengeRecord, consume_challenge(), issue_challenge(), IssuedChallenge, datetime, WebAuthn ceremony challenge 的公共领域 seam。, 签发绑定上下文、五分钟有效且只保存摘要的 challenge。 (+24 more)

### Community 44 - "Spec Kit Skills"
Cohesion: 0.12
...
### Community 45 - "AI Job Creation"
Cohesion: 0.27
Nodes (4): Any, LessonPlanRepository, SettingsRepository, UUID

### Community 46 - "Web BFF API Requests"
Cohesion: 0.12
...
### Community 47 - "Tenant Schema Migration Tests"
Cohesion: 0.09
...
### Community 50 - "Batch Job Query Aggregation"
Cohesion: 0.13
...
### Community 51 - "AI Settings Repository"
Cohesion: 0.11
Nodes (14): AiSettingsError, AiSettingsRepository, AiSettingsView, CredentialPort, Any, Protocol, RuntimeError, 单一 AI 模型、OS 凭据与提示词覆盖的应用服务。 (+6 more)

### Community 52 - "User Management Routes"
Cohesion: 0.21
Nodes (31): activate(), create_user(), credential_revoke(), credentials(), deactivate(), get_user(), _invitation(), invitation_issue() (+23 more)

### Community 53 - "Word Export Storage"
Cohesion: 0.11
Nodes (22): ExportDownload, _native_url(), Word 导出创建、历史、详情与实时授权下载用例。, build_display_filename(), ExportStorage, new_storage_key(), Path, UUID (+14 more)

### Community 54 - "AI Client Contract Tests"
Cohesion: 0.14
Nodes (25): _module(), test_client_accepts_loopback_http_and_non_loopback_https(), test_client_enforces_fixed_timeout_and_response_limit(), test_client_rejects_insecure_or_userinfo_endpoints_without_network(), test_client_rejects_redirect_without_following_location(), test_retryable_failure_is_retried_at_most_twice(), MemoryWindowsBackend, _module() (+17 more)

### Community 55 - "Prompt API Routes"
Cohesion: 0.17
...
### Community 56 - "Web Plan & Export Requests"
Cohesion: 0.11
...
### Community 57 - "Daily Plan Editor Page"
Cohesion: 0.14
Nodes (10): EditorKind, QLabel, DailyPlanPage, FieldDefinition, _lines(), ProcessEditor, Any, QWidget (+2 more)

### Community 58 - "Word Export Job Store"
Cohesion: 0.12
Nodes (13): canonical_export_content_sha256(), Any, _has_valid_frozen_input(), PostgresWordExportStore, Any, datetime, Protocol, RuntimeError (+5 more)

### Community 59 - "AI Batch Generation Tests"
Cohesion: 0.18
Nodes (26): create_completed_ai_preview(), provision_enabled_ai_model(), TestClient, UUID, _configure_batch_areas(), _idempotent_headers(), TestClient, test_batch_accepts_exactly_four_independent_children_and_derives_parent() (+18 more)

### Community 60 - "Admin Initialization CLI"
Cohesion: 0.14
...
### Community 62 - "Lesson Plan Completeness Rules"
Cohesion: 0.10
Nodes (22): _area_complete(), content_completeness(), _group_activity_complete(), _morning_activity_complete(), _morning_talk_complete(), _three_questions(), _three_statements(), AiGroupActivityStep (+14 more)

### Community 63 - "Settings View Models"
Cohesion: 0.15
Nodes (15): AbstractContextManager, _areas(), _class_view(), ClassView, KindergartenView, date, Protocol, ValueError (+7 more)

### Community 64 - "Auth Throttle"
Cohesion: 0.13
...
### Community 65 - "Security Architecture & ADRs"
Cohesion: 0.12
...
### Community 69 - "Auth Token Service"
Cohesion: 0.30
Nodes (11): AuthResult, create_access_token(), decode_access_token(), generate_refresh_token(), hash_refresh_token(), Any, datetime, Access JWT 与 opaque Refresh token 接缝。 (+3 more)
...
### Community 72 - "First-Run Plan Flow Tests"
Cohesion: 0.26
Nodes (17): _build(), _child(), FakeDesktopServices, Any, LogCaptureFixture, MonkeyPatch, Path, QtBot (+9 more)

### Community 73 - "AI Result Repository"
Cohesion: 0.21
Nodes (13): AiGenerationResultRecord, AiGenerationResultRepository, _json_object(), _optional_uuid(), Any, datetime, 同园隔离的 AI 生成结果 Repository。, 将同园到期预览条件收敛为 expired，不修改结果正文或决策字段。 (+5 more)

### Community 74 - "Export API Tests"
Cohesion: 0.31
...
### Community 75 - "Plan Permission Tests"
Cohesion: 0.12
Nodes (28): FastAPI, ActorFixture, TestClient, test_open_requires_current_semester(), test_teacher_list_hides_plans_when_the_associated_class_is_inactive(), test_unassociated_admin_can_view_and_archive_but_cannot_edit_body(), MonkeyPatch, TestClient (+20 more)

### Community 76 - "Alembic Database Migrations"
Cohesion: 0.09
Nodes (6): Alembic 迁移, Any, Column, _timestamps(), upgrade(), 桌面 SQLite 表元数据；Schema 只由独立 Alembic 链创建。

### Community 77 - "AI Job Dispatcher & Recovery"
Cohesion: 0.19
...
### Community 78 - "Desktop Main Window"
Cohesion: 0.12
Nodes (12): ColorScheme, QCloseEvent, ResolvedTheme, DesktopMainWindow, QWidget, ThemePreference, _validated_theme(), desktop_stylesheet() (+4 more)

### Community 79 - "Feature Specs & Contracts"
Cohesion: 0.13
...
### Community 80 - "AI Prompt Definitions"
Cohesion: 0.16
...
### Community 81 - "Quickstart & Quality Gates"
Cohesion: 0.09
...
### Community 82 - "AI Preview UI Flow"
Cohesion: 0.15
Nodes (5): AiPreviewFlow, UUID, 不依赖 Qt 的预览状态机；所有正文变更必须由显式 intent 触发。, SectionFailure, SectionPreview

### Community 83 - "AI Result Schemas"
Cohesion: 0.20
Nodes (19): AreaGameResult, build_generation_input(), canonical_json_sha256(), _ClosedResult, DailyReflectionResult, MorningActivityResult, MorningTalkResult, BaseModel (+11 more)

### Community 84 - "Health Check Tests"
Cohesion: 0.23
...
### Community 85 - "AI Job Retry Tests"
Cohesion: 0.21
...
### Community 86 - "Prompt Test API Tests"
Cohesion: 0.33
...
### Community 87 - "Health Dependencies"
Cohesion: 0.17
...
### Community 88 - "AI Generation Service Tests"
Cohesion: 0.32
Nodes (14): ai_generation_service(), AiGenerationService, AiBatchRequest, AiGenerationRequest, _native_url(), TestClient, UUID, RecordingDispatcher (+6 more)

### Community 89 - "UI Navigation Capabilities"
Cohesion: 0.17
...
### Community 92 - "AI Model Profile Tests"
Cohesion: 0.22
Nodes (17): ai_admin_client(), _profile_payload(), Any, TestClient, _resolver(), test_admin_creates_write_only_masked_profile_and_cannot_read_key(), test_call_fields_increment_revision_but_display_and_limits_do_not(), test_disable_preserves_profile_and_default_switch_is_tenant_local() (+9 more)

### Community 93 - "Backup Auth Tests"
Cohesion: 0.30
...
### Community 96 - "Word Export Service"
Cohesion: 0.33
Nodes (4): ExportService, LessonPlanRepository, UUID, RedisJobDispatcher

### Community 97 - "Prompt Test Store"
Cohesion: 0.30
Nodes (3): PostgresPromptTestStore, Any, UUID

### Community 98 - "Backup Auth Isolation Tests"
Cohesion: 0.25
...
### Community 99 - "FastAPI Application Assembly"
Cohesion: 0.19
...
### Community 100 - "AI Generation Pipeline"
Cohesion: 0.13
...
### Community 103 - "Database Profile Security Tests"
Cohesion: 0.31
...
### Community 106 - "Passkey Identity Isolation Tests"
Cohesion: 0.28
...
### Community 109 - "BFF Proxy Client"
Cohesion: 0.21
...
### Community 110 - "AI Job Status UI"
Cohesion: 0.17
...
### Community 114 - "Runtime OpenAPI Contract"
Cohesion: 0.37
...
### Community 116 - "Teacher Plan Renderer"
Cohesion: 0.28
...
### Community 117 - "Web Entry Security"
Cohesion: 0.25
...
### Community 118 - "Security Configuration Validation"
Cohesion: 0.25
...
### Community 121 - "Backup Maintenance Tests"
Cohesion: 0.40
...
### Community 122 - "Invitation Registration Tests"
Cohesion: 0.33
...
### Community 125 - "Credential Management Tests"
Cohesion: 0.36
...
### Community 126 - "Plan AI Contracts"
Cohesion: 0.29
...
### Community 127 - "AI Generation Coordinator"
Cohesion: 0.32
Nodes (10): _coordinator(), _module(), PreviewStore, UUID, ScriptedRuntime, test_adoption_snapshots_before_mutating_current_content(), test_batch_keeps_successful_previews_when_one_section_fails(), test_cancel_and_close_discard_late_results() (+2 more)
...
### Community 129 - "Auth Contract Tests"
Cohesion: 0.21
...
### Community 130 - "Controlled Agent Runtime ADR"
Cohesion: 0.17
...
### Community 131 - "Desktop Slice 2A RED"
Cohesion: 0.24
...
### Community 132 - "AI Settings Widget"
Cohesion: 0.26
Nodes (4): QFrame, QScrollArea, AiSettingsPage, QWidget

### Community 133 - "Backup Package Contract"
Cohesion: 0.17
Nodes (12): 10. 验证矩阵, 1. 范围, 2. 内部完整包, 3. 一致性快照生成, 4. 加密信封, 5. 凭据存储, 6. 远程对象, 7. 轮换 (+4 more)

### Community 134 - "Settings Contract Tests"
Cohesion: 0.24
...
### Community 135 - "AI Prompt Repositories"
Cohesion: 0.30
...
### Community 136 - "OpenAPI Contract Assembly"
Cohesion: 0.29
...
### Community 139 - "Backup Auth Contract"
Cohesion: 0.24
...
### Community 140 - "Word Export Contract"
Cohesion: 0.33
...
### Community 141 - "Export Repository Tests"
Cohesion: 0.55
...
### Community 145 - "BFF Client IP Trust"
Cohesion: 0.33
...
### Community 148 - "Lesson Plan Domain"
Cohesion: 0.24
...
### Community 149 - "Group Activity Source Tests"
Cohesion: 0.49
...
### Community 150 - "Local Development Profiles"
Cohesion: 0.27
...
### Community 151 - "Architecture Boundary Tests"
Cohesion: 0.40
...
### Community 152 - "Workday Service Tests"
Cohesion: 0.29
...
### Community 153 - "AI Adoption Service Tests"
Cohesion: 0.58
...
### Community 154 - "System Service Architecture"
Cohesion: 0.31
...
### Community 157 - "OpenAPI Document Tests"
Cohesion: 0.36
...
### Community 158 - "Word Export Migration"
Cohesion: 0.25
...
### Community 159 - "Secret Encryption Tests"
Cohesion: 0.39
...
### Community 160 - "API Entry Security"
Cohesion: 0.32
...
### Community 162 - "Agent Runtime Decisions"
Cohesion: 0.25
...
### Community 168 - "Passkey Migration Tests"
Cohesion: 0.54
...
### Community 169 - "Content Schema Validation"
Cohesion: 0.54
...
### Community 170 - "AI Key Envelope Tests"
Cohesion: 0.39
...
### Community 171 - "AI Model URL Policy"
Cohesion: 0.57
...
### Community 172 - "Prompt Catalog Tests"
Cohesion: 0.43
...
### Community 173 - "Passkey Expand Migration"
Cohesion: 0.52
Nodes (5): Any, Column, _tenant_identity_columns(), _timestamps(), upgrade()

### Community 174 - "Group Activity Sources"
Cohesion: 0.33
...
### Community 175 - "Group Activity Jobs"
Cohesion: 0.38
...
### Community 176 - "Settings Domain Features"
Cohesion: 0.29
...
### Community 177 - "Daily Plan Context"
Cohesion: 0.33
Nodes (3): DailyPlanContext, date, date

### Community 178 - "Job Polling Tests"
Cohesion: 0.71
...
### Community 179 - "AI Preview Flow"
Cohesion: 0.52
Nodes (6): _flow(), test_adopt_and_reject_emit_only_explicit_preview_intents(), test_ai_entry_is_optional_and_unconfigured_state_does_not_block_manual_flow(), test_duplicate_start_shows_fixed_single_operation_message(), test_page_change_invalidates_epoch_and_discards_late_signal(), test_per_section_preview_failure_and_retry_remain_independent()

### Community 180 - "Prompt Renderer Tests"
Cohesion: 0.48
...
### Community 183 - "Identity Audit Migration"
Cohesion: 0.53
Nodes (4): Column, datetime, _timestamps(), upgrade()

### Community 184 - "Settings Migration"
Cohesion: 0.47
Nodes (4): Any, Column, _timestamps(), upgrade()

### Community 185 - "Backup Login Migration"
Cohesion: 0.47
Nodes (4): Any, Column, _timestamps(), upgrade()

### Community 186 - "Lesson Plans Migration"
Cohesion: 0.47
Nodes (4): Any, Column, _timestamps(), upgrade()

### Community 187 - "Group Activity Sources Migration"
Cohesion: 0.47
Nodes (4): Any, Column, _timestamps(), upgrade()

### Community 188 - "Word Exports Migration"
Cohesion: 0.47
Nodes (4): Any, Column, _timestamps(), upgrade()

### Community 189 - "Word Export Contract"
Cohesion: 0.33
...
### Community 192 - "Desktop Slice 1 Acceptance"
Cohesion: 0.40
...
### Community 198 - "Graphify Query Timing Rules"
Cohesion: 0.40
...
### Community 199 - "Task ID Corrections"
Cohesion: 0.40
...
### Community 201 - "Auth Assurance Tests"
Cohesion: 0.38
...
### Community 202 - "AI Key Rotation CLI Tests"
Cohesion: 0.60
...
### Community 203 - "Identity Migration Tests"
Cohesion: 0.50
...
### Community 204 - "Lesson Calendar Tests"
Cohesion: 0.70
...
### Community 205 - "Export Section Confirmation"
Cohesion: 0.50
Nodes (4): missing_export_sections(), ExportSection, PlanContentV1, 返回需要二次确认的五栏；反思永远不参与确认。

### Community 207 - "Lesson Plan Contract Tests"
Cohesion: 0.83
...
### Community 216 - "Desktop Local-First Tasks"
Cohesion: 0.67
Nodes (3): Desktop Local-First Tasks, Task Implementation, Test Execution

### Community 317 - "Authenticated Session Dependency"
Cohesion: 0.67
Nodes (3): authenticated_session(), IdentityServiceDependency, Cookie

### Community 318 - "AI Client Implementation"
Cohesion: 0.16
Nodes (13): Client, AiClientError, _chat_completions_endpoint(), ProviderNeutralAiClient, Any, BaseTransport, RuntimeError, validate_base_url() (+5 more)
...
## Knowledge Gaps
- **356 isolated node(s):** `check-prerequisites.sh script`, `common.sh script`, `create-new-feature.sh script`, `setup-plan.sh script`, `setup-tasks.sh script` (+351 more)
