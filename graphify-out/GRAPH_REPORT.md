...
## Corpus Check
- 127 files · ~78,577 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2042 nodes · 1626 edges · 695 communities (168 shown, 527 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3fd32763`
...
- [[_COMMUNITY_Child Manager 2026-07-14 编码前审查解决方案|Child Manager 2026-07-14 编码前审查解决方案]]
...
- [[_COMMUNITY_D1 历史隐私清理完成并关闭 M0-G7|D1 历史隐私清理完成并关闭 M0-G7]]
...
- [[_COMMUNITY_Child Manager 双实现本地开发环境|Child Manager 双实现本地开发环境]]
...
- [[_COMMUNITY_Core Principles|Core Principles]]
- [[_COMMUNITY_API v1 契约总则|API v1 契约总则]]
- [[_COMMUNITY_双实现本地开发环境|双实现本地开发环境]]
...
- [[_COMMUNITY_SKILL|SKILL.md]]
- [[_COMMUNITY_Child Manager OpenAPI v1|Child Manager OpenAPI v1]]
- [[_COMMUNITY_SKILL|SKILL.md]]
- [[_COMMUNITY_SKILL|SKILL.md]]
- [[_COMMUNITY_3. 总体建模原则|3. 总体建模原则]]
- [[_COMMUNITY_9. 一日活动计划模型|9. 一日活动计划模型]]
- [[_COMMUNITY_技术栈与中国大陆网络边界|技术栈与中国大陆网络边界]]
...
- [[_COMMUNITY_M0 至 M9 里程碑依赖链|M0 至 M9 里程碑依赖链]]
- [[_COMMUNITY_5. 园所与身份模型|5. 园所与身份模型]]
- [[_COMMUNITY_6. 教学设置模型|6. 教学设置模型]]
- [[_COMMUNITY_3. PostgreSQL 物理约定|3. PostgreSQL 物理约定]]
- [[_COMMUNITY_5. 园所与身份 Schema|5. 园所与身份 Schema]]
- [[_COMMUNITY_6. 教学设置 Schema|6. 教学设置 Schema]]
- [[_COMMUNITY_9. 一日活动计划 Schema|9. 一日活动计划 Schema]]
- [[_COMMUNITY_9. 后台任务架构|9. 后台任务架构]]
...
- [[_COMMUNITY_首期范围：一日活动计划|首期范围：一日活动计划]]
...
- [[_COMMUNITY_2. 设计来源与旧系统取舍|2. 设计来源与旧系统取舍]]
- [[_COMMUNITY_8. 提示词模型|8. 提示词模型]]
...
- [[_COMMUNITY_7. AI 模型档案|7. AI 模型档案]]
- [[_COMMUNITY_10. 后台任务与 AI 结果 Schema|10. 后台任务与 AI 结果 Schema]]
- [[_COMMUNITY_12. 系统支撑 Schema|12. 系统支撑 Schema]]
- [[_COMMUNITY_2. 事实来源与旧仓库取舍|2. 事实来源与旧仓库取舍]]
- [[_COMMUNITY_7. AI 模型档案 Schema|7. AI 模型档案 Schema]]
- [[_COMMUNITY_11. Word 与文件架构|11. Word 与文件架构]]
- [[_COMMUNITY_13. 配置、密钥与安全|13. 配置、密钥与安全]]
...
- [[_COMMUNITY_分阶段任务执行与验证|分阶段任务执行与验证]]
- [[_COMMUNITY_阶段一数据模型、契约与验证指南|阶段一数据模型、契约与验证指南]]
- [[_COMMUNITY_阶段零研究与消歧|阶段零研究与消歧]]
- [[_COMMUNITY_规格质量清单迭代验证|规格质量清单迭代验证]]
...
- [[_COMMUNITY_项目宪章模板|项目宪章模板]]
- [[_COMMUNITY_宪章检查与两阶段设计门禁|宪章检查与两阶段设计门禁]]
- [[_COMMUNITY_实施计划模板|实施计划模板]]
- [[_COMMUNITY_功能规格模板|功能规格模板]]
...
- [[_COMMUNITY_一键生成四栏目|一键生成四栏目]]
- [[_COMMUNITY_乐观锁禁止静默覆盖|乐观锁禁止静默覆盖]]
- [[_COMMUNITY_生产部署延后至功能验收后|生产部署延后至功能验收后]]
- [[_COMMUNITY_提示词白名单与发布版本|提示词白名单与发布版本]]
...
- [[_COMMUNITY_Cloud-only 首期范围|Cloud-only 首期范围]]
- [[_COMMUNITY_生产部署延后至 M9|生产部署延后至 M9]]
- [[_COMMUNITY_园所数据隔离边界|园所数据隔离边界]]
- [[_COMMUNITY_M0 complete 与 M1 ready|M0 complete 与 M1 ready]]
- [[_COMMUNITY_Web API Worker 服务边界|Web API Worker 服务边界]]
- [[_COMMUNITY_避免日期专用文档提交|避免日期专用文档提交]]
- [[_COMMUNITY_Codex 实现子 Issue|Codex 实现子 Issue]]
- [[_COMMUNITY_共同基线分支创建|共同基线分支创建]]
- [[_COMMUNITY_冲突冻结|冲突冻结]]
- [[_COMMUNITY_双 Agent 启动前检查清单|双 Agent 启动前检查清单]]
- [[_COMMUNITY_GitHub Issue 创建阶段|GitHub Issue 创建阶段]]
- [[_COMMUNITY_graphify 完整性验收|graphify 完整性验收]]
- [[_COMMUNITY_graphify 工作区修改处置|graphify 工作区修改处置]]
- [[_COMMUNITY_独立授权边界|独立授权边界]]
- [[_COMMUNITY_实时基线证据|实时基线证据]]
- [[_COMMUNITY_M1 出口门禁|M1 出口门禁]]
- [[_COMMUNITY_M1 Issue 结构|M1 Issue 结构]]
- [[_COMMUNITY_非破坏性工作区保留|非破坏性工作区保留]]
- [[_COMMUNITY_生产部署非目标|生产部署非目标]]
- [[_COMMUNITY_只读交叉评审|只读交叉评审]]
- [[_COMMUNITY_推荐执行顺序|推荐执行顺序]]
- [[_COMMUNITY_共享文档同步|共享文档同步]]
- [[_COMMUNITY_M1 共享父 Issue|M1 共享父 Issue]]
- [[_COMMUNITY_启动清单循环措辞澄清|启动清单循环措辞澄清]]
- [[_COMMUNITY_执行停止条件|执行停止条件]]
- [[_COMMUNITY_T003 共享授权与分支门禁|T003 共享授权与分支门禁]]
- [[_COMMUNITY_T004-T020 实现任务|T004-T020 实现任务]]
- [[_COMMUNITY_TDD 驱动的 M1 实现|TDD 驱动的 M1 实现]]
- [[_COMMUNITY_Trae 实现子 Issue|Trae 实现子 Issue]]
- [[_COMMUNITY_2026-07-14 只读编码前收敛审查报告|2026-07-14 只读编码前收敛审查报告]]
- [[_COMMUNITY_分支操作授权门禁|分支操作授权门禁]]
- [[_COMMUNITY_Canonical 阶段状态一致性|Canonical 阶段状态一致性]]
- [[_COMMUNITY_当前不能进入编码|当前不能进入编码]]
- [[_COMMUNITY_combined-audit|combined-audit.md]]
- [[_COMMUNITY_有条件进入 M1 Issue 设计与草拟阶段|有条件进入 M1 Issue 设计与草拟阶段]]
- [[_COMMUNITY_宪章约束已进入计划与任务|宪章约束已进入计划与任务]]
- [[_COMMUNITY_CONTEXT|CONTEXT.md]]
- [[_COMMUNITY_双 Agent 开发协议|双 Agent 开发协议]]
- [[_COMMUNITY_Git 与 GitHub 基线|Git 与 GitHub 基线]]
- [[_COMMUNITY_新报告 Graphify 语义更新待确认|新报告 Graphify 语义更新待确认]]
- [[_COMMUNITY_既有 Graphify 工作区修改|既有 Graphify 工作区修改]]
- [[_COMMUNITY_I-01 Issue 粒度与任务映射|I-01 Issue 粒度与任务映射]]
- [[_COMMUNITY_I-02 启动清单循环措辞|I-02 启动清单循环措辞]]
- [[_COMMUNITY_I-03 工作区基线清洁|I-03 工作区基线清洁]]
- [[_COMMUNITY_I-04 状态日期|I-04 状态日期]]
- [[_COMMUNITY_实现授权门禁|实现授权门禁]]
- [[_COMMUNITY_GitHub Issue 操作授权门禁|GitHub Issue 操作授权门禁]]
- [[_COMMUNITY_M0-G1 至 M0-G8 已关闭|M0-G1 至 M0-G8 已关闭]]
- [[_COMMUNITY_M1 Codex 实现子 Issue|M1 Codex 实现子 Issue]]
- [[_COMMUNITY_M1 父子 Issue 层级|M1 父子 Issue 层级]]
- [[_COMMUNITY_M1 共享父 Issue|M1 共享父 Issue]]
- [[_COMMUNITY_M1 Trae 实现子 Issue|M1 Trae 实现子 Issue]]
- [[_COMMUNITY_M9 生产部署延后|M9 生产部署延后]]
- [[_COMMUNITY_plan|plan.md]]
- [[_COMMUNITY_双 Agent 只读交叉评审|双 Agent 只读交叉评审]]
- [[_COMMUNITY_docsROADMAP|docs/ROADMAP.md]]
- [[_COMMUNITY_spec|spec.md]]
- [[_COMMUNITY_Spec Kit 需求与任务完整覆盖|Spec Kit 需求与任务完整覆盖]]
- [[_COMMUNITY_T003 双实现分支任务|T003 双实现分支任务]]
- [[_COMMUNITY_T004 至 T020 有序执行清单|T004 至 T020 有序执行清单]]
...
- [[_COMMUNITY_class_teachers|class_teachers]]
...
- [[_COMMUNITY_ai_model_profile_capabilities|ai_model_profile_capabilities]]
- [[_COMMUNITY_ai_model_profiles|ai_model_profiles]]
- [[_COMMUNITY_Alembic 迁移序列|Alembic 迁移序列]]
- [[_COMMUNITY_审计只插入约束|审计只插入约束]]
- [[_COMMUNITY_audit_events|audit_events]]
- [[_COMMUNITY_background_jobs|background_jobs]]
- [[_COMMUNITY_class_areas|class_areas]]
- [[_COMMUNITY_class_teachers|class_teachers]]
- [[_COMMUNITY_classes|classes]]
- [[_COMMUNITY_daily_activity_plan_authors|daily_activity_plan_authors]]
- [[_COMMUNITY_daily_activity_plan_exports|daily_activity_plan_exports]]
- [[_COMMUNITY_daily_activity_plan_snapshots|daily_activity_plan_snapshots]]
- [[_COMMUNITY_daily_activity_plans|daily_activity_plans]]
- [[_COMMUNITY_导出快照、文件与状态约束|导出快照、文件与状态约束]]
- [[_COMMUNITY_园所组合外键矩阵|园所组合外键矩阵]]
- [[_COMMUNITY_后台任务状态、幂等与租约约束|后台任务状态、幂等与租约约束]]
- [[_COMMUNITY_kindergartens|kindergartens]]
- [[_COMMUNITY_lesson_plan_sources|lesson_plan_sources]]
...
- [[_COMMUNITY_AI 结果采用、拒绝与清理约束|AI 结果采用、拒绝与清理约束]]
- [[_COMMUNITY_prompt_definitions|prompt_definitions]]
- [[_COMMUNITY_prompt_test_runs|prompt_test_runs]]
- [[_COMMUNITY_prompt_versions|prompt_versions]]
- [[_COMMUNITY_refresh_tokens|refresh_tokens]]
...
- [[_COMMUNITY_M1 编码前有序启动流程|M1 编码前有序启动流程]]
- [[_COMMUNITY_独立实现子 Issue|独立实现子 Issue]]
- [[_COMMUNITY_共享文档独立提交同步|共享文档独立提交同步]]
- [[_COMMUNITY_共享父 Issue|共享父 Issue]]
- [[_COMMUNITY_M1 Codex 实现子 Issue|M1 Codex 实现子 Issue]]
- [[_COMMUNITY_确定性测试边界|确定性测试边界]]
- [[_COMMUNITY_既有 graphify 修改处置记录|既有 graphify 修改处置记录]]
- [[_COMMUNITY_Issue 分支实现独立授权门禁|Issue 分支实现独立授权门禁]]
- [[_COMMUNITY_live ready 健康语义|live ready 健康语义]]
- [[_COMMUNITY_本地 PostgreSQL 与 Redis 依赖基线|本地 PostgreSQL 与 Redis 依赖基线]]
- [[_COMMUNITY_M1 工程骨架|M1 工程骨架]]
- [[_COMMUNITY_M1 共享父 Issue|M1 共享父 Issue]]
- [[_COMMUNITY_M1 质量基线|M1 质量基线]]
- [[_COMMUNITY_红灯绿灯最小实现循环|红灯绿灯最小实现循环]]
- [[_COMMUNITY_T003 共同分支基线|T003 共同分支基线]]
- [[_COMMUNITY_T004 至 T020 权威任务|T004 至 T020 权威任务]]
- [[_COMMUNITY_Web API Worker 三个运行单元|Web API Worker 三个运行单元]]
- [[_COMMUNITY_M1 Trae 实现子 Issue|M1 Trae 实现子 Issue]]
- [[_COMMUNITY_Web API 依赖方向|Web API 依赖方向]]
- [[_COMMUNITY_审计事实来源链|审计事实来源链]]
- [[_COMMUNITY_文档交叉审计合并结论|文档交叉审计合并结论]]
- [[_COMMUNITY_M0-G1 至 M0-G8 已关闭|M0-G1 至 M0-G8 已关闭]]
- [[_COMMUNITY_审计结论不授权后续操作|审计结论不授权后续操作]]
- [[_COMMUNITY_Q1 至 Q26 最终结论|Q1 至 Q26 最终结论]]
- [[_COMMUNITY_模板脱敏与历史清理边界|模板脱敏与历史清理边界]]
...
- [[_COMMUNITY_里程碑门禁证据|里程碑门禁证据]]
- [[_COMMUNITY_M0 共享设计基线|M0 共享设计基线]]
- [[_COMMUNITY_M1 工程骨架与质量基线|M1 工程骨架与质量基线]]
- [[_COMMUNITY_M7 固定 Word 导出与历史|M7 固定 Word 导出与历史]]
- [[_COMMUNITY_M9 生产安全与部署复审|M9 生产安全与部署复审]]
- [[_COMMUNITY_内容门禁与操作授权分离|内容门禁与操作授权分离]]
- [[_COMMUNITY_combined-audit 审计事实基线|combined-audit 审计事实基线]]
- [[_COMMUNITY_最终 docs-only main 共享基线|最终 docs-only main 共享基线]]
- [[_COMMUNITY_Child Manager 20260713 编码前审查报告|Child Manager 20260713 编码前审查报告]]
- [[_COMMUNITY_FR-031 快照原因码与恢复顺序|FR-031 快照原因码与恢复顺序]]
- [[_COMMUNITY_Git 历史隐私清理|Git 历史隐私清理]]
- [[_COMMUNITY_M0 complete|M0 complete]]
- [[_COMMUNITY_M0-G1 至 M0-G8 门禁体系|M0-G1 至 M0-G8 门禁体系]]
- [[_COMMUNITY_M1 ready|M1 ready]]
- [[_COMMUNITY_Q13 客户端幂等 scope 与 fingerprint|Q13 客户端幂等 scope 与 fingerprint]]
- [[_COMMUNITY_T002 Pre-M1 一致性审查|T002 Pre-M1 一致性审查]]
- [[_COMMUNITY_T003 双 Agent 同基线分支流程|T003 双 Agent 同基线分支流程]]
- [[_COMMUNITY_模板说明契约一致性|模板说明契约一致性]]
- [[_COMMUNITY_内容门禁与操作授权分离|内容门禁与操作授权分离]]
- [[_COMMUNITY_模板、FR-031 与 Q13 契约对齐|模板、FR-031 与 Q13 契约对齐]]
- [[_COMMUNITY_M0 阻塞项统一修复执行方案|M0 阻塞项统一修复执行方案]]
- [[_COMMUNITY_历史隐私清理与最终 docs-only 基线|历史隐私清理与最终 docs-only 基线]]
- [[_COMMUNITY_M0 分阶段修复闭环|M0 分阶段修复闭环]]
- [[_COMMUNITY_T003 双 Agent 同基线分支流程|T003 双 Agent 同基线分支流程]]
- [[_COMMUNITY_Spec Kit 与 graphify 专项验证门禁|Spec Kit 与 graphify 专项验证门禁]]
...
- [[_COMMUNITY_任务幂等契约|任务幂等契约]]
- [[_COMMUNITY_各任务输入快照|各任务输入快照]]
- [[_COMMUNITY_任务类型|任务类型]]
...
- [[_COMMUNITY_任务与 AI 预览端点|任务与 AI 预览端点]]
- [[_COMMUNITY_乐观锁契约|乐观锁契约]]
- [[_COMMUNITY_权限矩阵|权限矩阵]]
...
- [[_COMMUNITY_通用数据规则|通用数据规则]]
- [[_COMMUNITY_daily_activity_plan_exports 导出快照|daily_activity_plan_exports 导出快照]]
- [[_COMMUNITY_必测数据行为|必测数据行为]]
- [[_COMMUNITY_园所与身份实体组|园所与身份实体组]]
- [[_COMMUNITY_六阶段迁移顺序|六阶段迁移顺序]]
- [[_COMMUNITY_学期外周次双空|学期外周次双空]]
- [[_COMMUNITY_PlanContentV1 六栏目|PlanContentV1 六栏目]]
...
- [[_COMMUNITY_AI 结构化预览与教师采用|AI 结构化预览与教师采用]]
- [[_COMMUNITY_客户端幂等 scope 与 fingerprint|客户端幂等 scope 与 fingerprint]]
- [[_COMMUNITY_pending_dispatch 恢复机制|pending_dispatch 恢复机制]]
- [[_COMMUNITY_PostgreSQL 权威状态|PostgreSQL 权威状态]]
- [[_COMMUNITY_NiceGUI 同源 BFF|NiceGUI 同源 BFF]]
- [[_COMMUNITY_T003 双实现分支授权|T003 双实现分支授权]]
...
- [[_COMMUNITY_集体活动与安全 DOCX 验收|集体活动与安全 DOCX 验收]]
- [[_COMMUNITY_锁定安装与本地依赖|锁定安装与本地依赖]]
- [[_COMMUNITY_M8 完整验收记录|M8 完整验收记录]]
- [[_COMMUNITY_纯手工教案浏览器验收|纯手工教案浏览器验收]]
- [[_COMMUNITY_前提与反目标|前提与反目标]]
- [[_COMMUNITY_自动化质量门禁|自动化质量门禁]]
- [[_COMMUNITY_反思事务验收|反思事务验收]]
...
- [[_COMMUNITY_一键、反思与集体部分成功|一键、反思与集体部分成功]]
- [[_COMMUNITY_Pre-M1 canonical 文档同步|Pre-M1 canonical 文档同步]]
- [[_COMMUNITY_研究方法与决策优先级|研究方法与决策优先级]]
- [[_COMMUNITY_生产部署与未来子系统排除|生产部署与未来子系统排除]]
- [[_COMMUNITY_故障隔离矩阵|故障隔离矩阵]]
- [[_COMMUNITY_PostgreSQL 权威任务与恢复|PostgreSQL 权威任务与恢复]]
- [[_COMMUNITY_白名单确定性渲染|白名单确定性渲染]]
- [[_COMMUNITY_栏目级预览有效性|栏目级预览有效性]]
- [[_COMMUNITY_异步提示词测试冻结配置|异步提示词测试冻结配置]]
- [[_COMMUNITY_Phase 0 研究决策|Phase 0 研究决策]]
- [[_COMMUNITY_当前学期与学期外日期|当前学期与学期外日期]]
- [[_COMMUNITY_七个稳定提示词|七个稳定提示词]]
- [[_COMMUNITY_M1–M8 单一 Feature|M1–M8 单一 Feature]]
- [[_COMMUNITY_快照只表达可恢复变化|快照只表达可恢复变化]]
- [[_COMMUNITY_固定结构化 AI 结果|固定结构化 AI 结果]]
- [[_COMMUNITY_Python 3.14 技术基线|Python 3.14 技术基线]]
- [[_COMMUNITY_独立运行单元与模块化单体|独立运行单元与模块化单体]]
- [[_COMMUNITY_固定 Word 模板与导出快照|固定 Word 模板与导出快照]]
- [[_COMMUNITY_工作日来源与三类缓存 TTL|工作日来源与三类缓存 TTL]]
- [[_COMMUNITY_集体活动拆分与新增环节流程|集体活动拆分与新增环节流程]]
- [[_COMMUNITY_首期一日活动计划功能规格|首期一日活动计划功能规格]]
- [[_COMMUNITY_M0 complete M1 ready 规格状态|M0 complete M1 ready 规格状态]]
- [[_COMMUNITY_一键四栏目 AI 批任务|一键四栏目 AI 批任务]]
- [[_COMMUNITY_纯手工教案闭环|纯手工教案闭环]]
- [[_COMMUNITY_安全审计与降级要求|安全审计与降级要求]]
- [[_COMMUNITY_教案快照原因码|教案快照原因码]]
- [[_COMMUNITY_固定 Word 模板保真|固定 Word 模板保真]]
- [[_COMMUNITY_执行授权边界与 RED seam 门禁|执行授权边界与 RED seam 门禁]]
- [[_COMMUNITY_首期一日活动计划完整闭环任务清单|首期一日活动计划完整闭环任务清单]]
- [[_COMMUNITY_Foundational 先写失败测试|Foundational 先写失败测试]]
- [[_COMMUNITY_Foundational T009–T020|Foundational T009–T020]]
- [[_COMMUNITY_Foundation 并行示例|Foundation 并行示例]]
- [[_COMMUNITY_US1  US2 并行示例|US1 / US2 并行示例]]
- [[_COMMUNITY_US3  US4  US5 并行示例|US3 / US4 / US5 并行示例]]
- [[_COMMUNITY_US6  US7  Polish 并行示例|US6 / US7 / Polish 并行示例]]
- [[_COMMUNITY_Phase 3 US1 管理员安全初始化与必要设置|Phase 3: US1 管理员安全初始化与必要设置]]
- [[_COMMUNITY_Phase 4 US2 教师纯手工教案闭环|Phase 4: US2 教师纯手工教案闭环]]
- [[_COMMUNITY_Phase 5 US3 管理员配置模型与提示词|Phase 5: US3 管理员配置模型与提示词]]
- [[_COMMUNITY_Phase 6 US4 教师按栏目使用 AI 并保留决定权|Phase 6: US4 教师按栏目使用 AI 并保留决定权]]
- [[_COMMUNITY_Phase 7 US5 教师处理集体活动原始教案|Phase 7: US5 教师处理集体活动原始教案]]
- [[_COMMUNITY_Phase 8 US6 教师导出并重新下载固定 Word|Phase 8: US6 教师导出并重新下载固定 Word]]
- [[_COMMUNITY_Phase 9 US7 管理员审计与可降级服务|Phase 9: US7 管理员审计与可降级服务]]
- [[_COMMUNITY_Polish T155–T165|Polish T155–T165]]
- [[_COMMUNITY_可收集且业务断言失败的 RED 门禁|可收集且业务断言失败的 RED 门禁]]
- [[_COMMUNITY_Setup T001–T008|Setup T001–T008]]
- [[_COMMUNITY_用户故事专项回归与 graphify 门禁|用户故事专项回归与 graphify 门禁]]
- [[_COMMUNITY_T002 最终候选基线 Pre-M1 一致性审查|T002 最终候选基线 Pre-M1 一致性审查]]
- [[_COMMUNITY_T003 双实现分支授权门禁|T003 双实现分支授权门禁]]
- [[_COMMUNITY_US1 T021–T041|US1 T021–T041]]
- [[_COMMUNITY_US2 T042–T057|US2 T042–T057]]
- [[_COMMUNITY_US3 T058–T082|US3 T058–T082]]
- [[_COMMUNITY_US4 T083–T106|US4 T083–T106]]
- [[_COMMUNITY_US5 T107–T122|US5 T107–T122]]
- [[_COMMUNITY_US6 T123–T137|US6 T123–T137]]
- [[_COMMUNITY_US7 T138–T154|US7 T138–T154]]
...
- [[_COMMUNITY_表格第五行：集体活动|表格第五行：集体活动]]
- [[_COMMUNITY_表格第六行：室内区域游戏|表格第六行：室内区域游戏]]
- [[_COMMUNITY_编号、句号、问号与换行格式|编号、句号、问号与换行格式]]
- [[_COMMUNITY_表格第三大行：晨间活动|表格第三大行：晨间活动]]
- [[_COMMUNITY_表格第四行：晨间谈话|表格第四行：晨间谈话]]
- [[_COMMUNITY_仅 AI 新增集体环节标红|仅 AI 新增集体环节标红]]
- [[_COMMUNITY_一日活动计划 Word 系统说明|一日活动计划 Word 系统说明]]
- [[_COMMUNITY_表格第一行：教学周次|表格第一行：教学周次]]
- [[_COMMUNITY_文件第一行：园所与学期月份范围|文件第一行：园所与学期月份范围]]
- [[_COMMUNITY_右侧列|右侧列]]
- [[_COMMUNITY_右侧列为两行：|右侧列为两行：]]
- [[_COMMUNITY_填写说明|填写说明]]
- [[_COMMUNITY_左侧列|左侧列]]
- [[_COMMUNITY_第一行：|第一行：]]
- [[_COMMUNITY_第二行：|第二行：]]
...
- [[_COMMUNITY_identity.py|identity.py]]
- [[_COMMUNITY_exports.py|exports.py]]
- [[_COMMUNITY_models.py|models.py]]
- [[_COMMUNITY_audit.py|audit.py]]
- [[_COMMUNITY_一日活动计划业务不变量|一日活动计划业务不变量]]
- [[_COMMUNITY_园所数据隔离|园所数据隔离]]
- [[_COMMUNITY_Web API Worker 服务边界|Web API Worker 服务边界]]
- [[_COMMUNITY_权威文档阅读顺序|权威文档阅读顺序]]
- [[_COMMUNITY_双 Agent 独立开发协议|双 Agent 独立开发协议]]
- [[_COMMUNITY_只读交叉评审|只读交叉评审]]
- [[_COMMUNITY_容器镜像 shell 变量覆盖|容器镜像 shell 变量覆盖]]
- [[_COMMUNITY_双实现本地开发环境|双实现本地开发环境]]
- [[_COMMUNITY_外部网络确定性测试替身|外部网络确定性测试替身]]
- [[_COMMUNITY_锁定的 Python 质量门禁工具链|锁定的 Python 质量门禁工具链]]
- [[_COMMUNITY_本地服务仅绑定回环地址|本地服务仅绑定回环地址]]
- [[_COMMUNITY_PostgreSQL 与 Redis 最小 Compose 依赖|PostgreSQL 与 Redis 最小 Compose 依赖]]
- [[_COMMUNITY_下载加速不等于外部服务连通性|下载加速不等于外部服务连通性]]
- [[_COMMUNITY_锁定官方容器镜像默认值|锁定官方容器镜像默认值]]
- [[_COMMUNITY_官方 PyPI 临时回退|官方 PyPI 临时回退]]
- [[_COMMUNITY_生产部署延后至 M9|生产部署延后至 M9]]
- [[_COMMUNITY_当前应用无需 npm 或 Node.js 安装链|当前应用无需 npm 或 Node.js 安装链]]
- [[_COMMUNITY_工作树端口数据运行时隔离|工作树端口数据运行时隔离]]
- [[_COMMUNITY_固定本地档位与运行时隔离|固定本地档位与运行时隔离]]
- [[_COMMUNITY_技术栈与中国大陆网络边界|技术栈与中国大陆网络边界]]
- [[_COMMUNITY_Codex 与 Trae 工作树隔离|Codex 与 Trae 工作树隔离]]
- [[_COMMUNITY_M1 工程骨架与质量基线 Issue 草稿|M1 工程骨架与质量基线 Issue 草稿]]
- [[_COMMUNITY_共享父 Issue 与实现子 Issue 模型|共享父 Issue 与实现子 Issue 模型]]
- [[_COMMUNITY_M1 工程骨架与质量基线|M1 工程骨架与质量基线]]
- [[_COMMUNITY_M6 AI 异步生成与人工采用|M6 AI 异步生成与人工采用]]
- [[_COMMUNITY_M0 至 M9 里程碑依赖链|M0 至 M9 里程碑依赖链]]
- [[_COMMUNITY_产品与工程路线图|产品与工程路线图]]
- [[_COMMUNITY_child-manager|child-manager]]
- [[_COMMUNITY_Cloud-only 三服务架构|Cloud-only 三服务架构]]
- [[_COMMUNITY_固定 Word 模板导出|固定 Word 模板导出]]
- [[_COMMUNITY_API v1 契约总则|API v1 契约总则]]
- [[_COMMUNITY_BFF 与可信上下文|BFF 与可信上下文]]
- [[_COMMUNITY_Cookie CSRF 会话契约|Cookie CSRF 会话契约]]
- [[_COMMUNITY_幂等异步任务契约|幂等异步任务契约]]
- [[_COMMUNITY_乐观锁与预览失效校验|乐观锁与预览失效校验]]
- [[_COMMUNITY_首期一日活动计划实现计划|首期一日活动计划实现计划]]
- [[_COMMUNITY_PostgreSQL 权威任务状态|PostgreSQL 权威任务状态]]
- [[_COMMUNITY_用户故事纵向切片策略|用户故事纵向切片策略]]
- [[_COMMUNITY_首期实现与验收合同|首期实现与验收合同]]
- [[_COMMUNITY_浏览器端到端验收路径|浏览器端到端验收路径]]
- [[_COMMUNITY_首期实现任务清单|首期实现任务清单]]
- [[_COMMUNITY_先 RED 后实现的执行顺序|先 RED 后实现的执行顺序]]
- [[_COMMUNITY_US1 至 US7 交付依赖链|US1 至 US7 交付依赖链]]

## God Nodes (most connected - your core abstractions)
1. `Child Manager 数据模型设计` - 24 edges
2. `教案管理 PRD（首期：一日活动计划）` - 22 edges
3. `Child Manager 系统架构设计` - 22 edges
4. `Child Manager Agent 开发规则` - 20 edges
5. `Child Manager PostgreSQL 数据库 Schema` - 19 edges
6. `Child Manager 产品与工程路线图` - 18 edges
7. `Tasks: 首期一日活动计划完整闭环` - 17 edges
8. `Base` - 16 edges
9. `Child Manager 项目上下文` - 15 edges
10. `Child Manager 幼儿园教育管理系统` - 15 edges

## Surprising Connections (you probably didn't know these)
- `test_database_url_override()` --calls--> `Settings`  [EXTRACTED]
  tests/test_config.py → packages/backend/bootstrap/config.py
- `test_redis_url_override()` --calls--> `Settings`  [EXTRACTED]
  tests/test_config.py → packages/backend/bootstrap/config.py
- `test_error_response_json()` --calls--> `ErrorResponse`  [EXTRACTED]
  tests/test_error_response.py → packages/contracts/common.py
- `test_error_response_model_structure()` --calls--> `ErrorResponse`  [EXTRACTED]
  tests/test_error_response.py → packages/contracts/common.py
- `完整 SDD 工作流` --references--> `Spec Kit 任务实施`  [EXTRACTED]
  .specify/workflows/speckit/workflow.yml → .agents/skills/speckit-implement/SKILL.md
...
## Communities (695 total, 527 thin omitted)
...
Cohesion: 0.22
Nodes (13): 20260713 编码前审查报告证据, D1 历史隐私清理完成并关闭 M0-G7, D2 最终共享基线完成并关闭 M0-G8, GitHub Issue 操作待单独授权, 历史计划状态与当前状态相区分, 独立授权边界, M0 complete, M1 ready (+5 more)
...
### Community 96 - "首期范围：一日活动计划"
Cohesion: 0.06
Nodes (22): ABC, datetime, DeclarativeBase, AgeGroup, Area, Class, ClassTeacher, Kindergarten (+14 more)
...
### Community 128 - "用户与权限"
Cohesion: 0.11
Nodes (6): Any, fetch_api(), BaseSettings, Settings, test_database_url_override(), test_redis_url_override()

### Community 607 - "BaseModel"
Cohesion: 0.21
Nodes (17): BaseModel, DailyReflection, LessonPlan, PlanArchiveRequest, PlanAuthor, PlanAutoSaveRequest, PlanContentV1, PlanCreateRequest (+9 more)

### Community 608 - "main.py"
Cohesion: 0.15
Nodes (5): lifespan(), request_id_middleware(), timing_middleware(), FastAPI, Request

### Community 609 - "settings.py"
Cohesion: 0.14
Nodes (13): AgeGroup, Area, AreaCreate, AreaUpdate, Class, ClassCreate, ClassTeacher, ClassUpdate (+5 more)

### Community 610 - "common.py"
Cohesion: 0.19
Nodes (9): ErrorResponse, FieldError, HealthCheckResult, HealthResponse, IdempotencyKey, PaginatedResponse, RequestContext, test_error_response_json() (+1 more)
...
Cohesion: 0.18
Nodes (10): Prompt, PromptCapability, PromptCreateRequest, PromptPublishRequest, PromptResultSchema, PromptTestRequest, PromptTestRun, PromptUpdateRequest (+2 more)

### Community 613 - "identity.py"
Cohesion: 0.20
Nodes (9): ChangePasswordRequest, LoginRequest, LoginResponse, Role, TokenRefreshResponse, User, UserCreate, UserRole (+1 more)

### Community 614 - "exports.py"
Cohesion: 0.33
Nodes (5): ExportConfirmRequest, ExportListResponse, ExportRecord, ExportRequest, MissingColumnWarning

### Community 615 - "models.py"
Cohesion: 0.33
Nodes (5): ModelProfile, ModelProfileCreateRequest, ModelProfileEnableRequest, ModelProfileListResponse, ModelProfileUpdateRequest

### Community 616 - "audit.py"
Cohesion: 0.40
Nodes (4): AuditEvent, AuditEventType, AuditListResponse, AuditQueryRequest

## Knowledge Gaps
- **1351 isolated node(s):** `check-prerequisites.sh script`, `common.sh script`, `create-new-feature.sh script`, `setup-plan.sh script`, `setup-tasks.sh script` (+1346 more)
...
- **Why does `Child Manager Agent 开发规则` connect `Child Manager Agent 开发规则` to `README.md`?**
