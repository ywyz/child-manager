...
## Summary
- 2100 nodes · 1784 edges · 652 communities (151 shown, 501 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 31 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `902b0904`
...
- `Ruff 格式门禁` --implements--> `1. 共享父 Issue 草稿`  [INFERRED]
  .github/workflows/quality.yml → docs/development/m1-issue-drafts.md
- `Ruff 静态检查门禁` --implements--> `1. 共享父 Issue 草稿`  [INFERRED]
  .github/workflows/quality.yml → docs/development/m1-issue-drafts.md
...
## Communities (652 total, 501 thin omitted)
...
### Community 2 - "app.py"
Cohesion: 0.09
Nodes (38): create_app(), _error_response(), UUID, FastAPI 应用装配、统一异常转换与健康端点。, _request_id(), _safe_check(), _available(), build_health_dependencies() (+30 more)
...
### Community 7 - "Phase 0 研究：首期一日活动计划完整闭环"
Cohesion: 0.05
...
### Community 20 - "ADR-0007：采用 Caddy、Docker Compose 与文件挂载 Secrets"
Cohesion: 0.10
...
### Community 24 - "test_local_development_profiles.py"
Cohesion: 0.14
...
### Community 32 - "Child Manager 数据模型设计"
Cohesion: 0.14
...
### Community 44 - "ADR-0002：采用独立 Web、API、Worker 运行单元的模块化单体"
Cohesion: 0.18
...
### Community 45 - "ADR-0004：采用同源入口、HttpOnly Cookie 与 API 统一授权"
Cohesion: 0.18
...
### Community 46 - "Child Manager PostgreSQL 数据库 Schema"
Cohesion: 0.18
...
### Community 50 - "Child Manager 文档交叉审计合并结论"
Cohesion: 0.20
...
### Community 69 - "test_openapi_document.py"
Cohesion: 0.43
...
- **Why does `Child Manager 系统架构设计` connect `Child Manager 系统架构设计` to `15. 生产部署延后边界`, `4. 架构总览`, `7. API 与契约`, `README.md`, `10. AI 与提示词架构`, `6. 请求、认证与授权`, `9. 后台任务架构`, `5. 代码组织与依赖方向`, `8. 数据架构`, `11. Word 与文件架构`, `13. 配置、密钥与安全`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `教案管理 PRD（首期：一日活动计划）` connect `教案管理 PRD（首期：一日活动计划）` to `15. 安全、隐私与审计`, `4. 产品目标`, `README.md`, `12. AI 模型与提示词管理`, `5. 用户与权限`, `7. 首期必要设置`, `8. 核心业务对象`, `9. 日期与上下文规则`, `18. 验收标准`, `11. 计划管理流程`, `14. Word 导出`, `17. 非功能要求`, `10. 教案栏目与格式`, `13. AI 生成流程`?**
...
- **Should `Python 质量门禁 Job` be split into smaller, more focused modules?**
