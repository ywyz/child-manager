...
## Corpus Check
- 156 files · ~83,794 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2273 nodes · 2048 edges · 708 communities (176 shown, 532 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 33 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cb235c08`
...
## Communities (708 total, 532 thin omitted)
...
Cohesion: 0.09
Nodes (47): _ai_unconfigured(), build_health_dependencies(), _calendar_library_available(), create_app(), custom_openapi(), _error_response(), HealthDependencies, _http_exception_handler() (+39 more)
...
Cohesion: 0.10
Nodes (35): canonical_fingerprint(), ErrorResponse, FieldError, HealthCheckResult, HealthResponse, idempotency_key_from_fingerprint(), IdempotencyKey, PaginatedResponse (+27 more)
...
Cohesion: 0.14
Nodes (15): DeclarativeBase, get_database_url(), Alembic 迁移环境。  模块级代码需兼容两种导入方式： 1. alembic.command.upgrade/downgrade 调用时，context., run_migrations_offline(), run_migrations_online(), Base, _get_database_url(), get_db_session() (+7 more)
...
### Community 695 - "test_openapi_document.py"
Cohesion: 0.14
Nodes (19): _load_spec(), Any, OpenAPI 契约锁定测试。  读取静态 openapi.yaml 并锁定关键结构，防止后续实现漂移。, page >= 1, page_size 1–100。, 静态 OpenAPI spec 应该是合法的 3.1。, UnavailableError 的 code 必须恰好是两个稳定 503 code。, Error schema 必须包含 code/message/request_id/field_errors。, ErrorField 必须包含 field/code/message。 (+11 more)
