...
## Corpus Check
- 156 files · ~84,400 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1740 nodes · 2108 edges · 174 communities (166 shown, 8 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 35 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ce2d3a85`
...
Cohesion: 0.08
Nodes (29): BaseSettings, Settings, get_db_session(), get_db_session 应该在成功时提交, get_db_session 应该在异常时回滚, get_db_session 应该返回数据库会话, test_get_db_session_commits_on_success(), test_get_db_session_returns_session() (+21 more)
