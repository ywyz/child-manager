...
## Summary
- 5655 nodes · 16594 edges · 324 communities (276 shown, 48 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 1841 edges (avg confidence: 0.56)
- Token cost: 20,372 input · 28,275 output

## Graph Freshness
- Built from commit: `7cf57cce`
...
- **Agent Requirements Coverage in Slice 2B** — fr_033_single_agent, fr_034_tool_only, fr_035_minimal_context, fr_036_read_draft_zero_write, fr_039_provider_port, fr_040_thread_transaction, fr_041_no_long_term_memory, sc_011_permission_matrix, sc_012_zero_persistence [EXTRACTED 0.85]
- **Slice 3 Backup/Restore Architecture** — kmbackup1_envelope, webdav_adapter, s3_adapter, slice_3_backup_restore, us3_backup_restore [EXTRACTED 0.85]
...
## Communities (324 total, 48 thin omitted)
...
Cohesion: 0.06
Nodes (50): _calendar_library_available(), map_timor_payload(), AsyncBaseTransport, date, TimorWorkdayClient, WorkdayResult, Any, date (+42 more)
...
Cohesion: 0.07
Nodes (51): ai_generation_service(), ai_retry_service(), export_service(), lesson_plan_service(), LessonPlanService, SettingsService, reflection_generation_service(), settings_service() (+43 more)

### Community 5 - "Identity and Authentication Service"
Cohesion: 0.11
Nodes (22): AuditRepository, ChallengePurpose, StrEnum, IdentityError, IdentityService, ManagedUser, Any, Exception (+14 more)
...
Cohesion: 0.06
Nodes (35): AdoptionTransaction, AiGenerationCoordinator, AiGenerationError, AiPreviewStore, GenerationRuntime, _Operation, PreviewView, AbstractContextManager (+27 more)

### Community 10 - "Lesson Plans and Exports"
Cohesion: 0.06
Nodes (35): Self, AdoptedContent, DayRenderer, ExportResult, Protocol, SnapshotReader, LessonPlanEditorState, LessonPlanError (+27 more)
...
Cohesion: 0.08
Nodes (45): Actor, AiJobScopeResolver, AiRunner, build_ai_job_runner(), build_ai_result_repository(), build_prompt_test_executor(), build_word_export_runner(), build_worker_scope_resolver() (+37 more)
...
Cohesion: 0.06
Nodes (25): DatabaseSource, AdoptionCandidate, ClassContext, PlanExportRecord, AiConfigurationRecord, AiPreviewRecord, AiRepository, AiRepositoryError (+17 more)

### Community 15 - "Development Workflow and Architecture"
Cohesion: 0.07
Nodes (63): CSRF & Origin Verification, ADR-0001 Cloud Only, kindergarten_id 园所隔离约束, Data Model Design, Database Schema Design, System Architecture, Repository Workflow Reset 2026-07-21, Codex Agent (+55 more)
...
Cohesion: 0.08
Nodes (46): current_session(), AuthenticatedSessionDependency, admin_client(), passkey_client(), MonkeyPatch, TestClient, 通过 FastAPI 身份依赖注入建立已 step-up 管理员，不借用密码登录。, provision_editable_plan_context() (+38 more)
...
Cohesion: 0.10
Nodes (19): AiExecutionContext, AiJobAuthorizer, AiJobStore, AiJobStoreProtocol, _log_sanitized_exception(), Any, datetime, Exception (+11 more)
...
Cohesion: 0.06
Nodes (19): CoordinatorState, AiSettingsView, T, DesktopServices, Any, date, Path, Protocol (+11 more)
...
Cohesion: 0.08
Nodes (40): lesson_plan_database(), MonkeyPatch, test_0006_creates_tenant_scoped_plan_snapshot_author_and_cache_tables(), test_database_contains_unique_cas_week_and_unavailable_constraints(), _columns(), _foreign_keys(), group_activity_source_database(), MonkeyPatch (+32 more)
...
Cohesion: 0.08
Nodes (28): Engine, BootstrapService, RuntimeError, StartupError, StartupState, _apply_sqlite_pragmas(), connect_sqlite(), create_session_factory() (+20 more)

### Community 30 - "Export Service"
Cohesion: 0.11
Nodes (24): ExportDownload, ExportService, _native_url(), LessonPlanRepository, UUID, Word 导出创建、历史、详情与实时授权下载用例。, build_display_filename(), ExportStorage (+16 more)

### Community 31 - "Daily Plan Workspace"
Cohesion: 0.08
Nodes (16): DailyPlanWorkspace, DesktopSettingsContext, _filename_part(), Any, date, LessonPlanService, Path, Protocol (+8 more)

### Community 32 - "Settings Application Logic"
Cohesion: 0.09
Nodes (20): CursorResult, _areas(), _class_view(), ClassView, KindergartenView, AbstractContextManager, date, Protocol (+12 more)

### Community 33 - "Background Task Runtime"
Cohesion: 0.11
Nodes (23): BackgroundTask, Event, QObject, QRunnable, ErrorCode, StrEnum, TaskProgress, UUID (+15 more)

### Community 34 - "Vendor-Neutral AI Client"
Cohesion: 0.08
Nodes (29): _pinned_url(), Any, OpenAI 兼容、禁止重定向且错误脱敏的供应商中立客户端。, AiClientError, RuntimeError, _addresses(), AiUrlPolicyError, Resolver (+21 more)

### Community 35 - "Export Repository"
Cohesion: 0.10
Nodes (18): ExportRecord, ExportRepository, Any, 园所范围 Word 导出 PostgreSQL Repository。, 所有查询和变更都同时约束 ``kindergarten_id``。, _record(), _uuid(), canonical_export_content_sha256() (+10 more)

### Community 36 - "Prompt Catalog and Schemas"
Cohesion: 0.32
Nodes (35): prompt_spec(), PromptSpec, 固定提示词目录、输入与结果 Schema 路由。, validate_prompt_result(), AiAreaGame, AiDailyReflection, AiGroupActivity, AiMorningActivity (+27 more)

### Community 37 - "Word Export Rendering"
Cohesion: 0.11
Nodes (26): DailyPlanExportSnapshot, ExportError, ExportService, Path, RuntimeError, BytesRenderer, _content(), _east_asia_font() (+18 more)

### Community 38 - "AI Batch Generation Tests"
Cohesion: 0.13
Nodes (36): create_completed_ai_preview(), provision_enabled_ai_model(), TestClient, UUID, _configure_batch_areas(), _idempotent_headers(), TestClient, test_batch_accepts_exactly_four_independent_children_and_derives_parent() (+28 more)

### Community 39 - "Exports API Router"
Cohesion: 0.12
Nodes (35): _accepted(), create_export(), download_export(), _export(), get_export(), _job(), list_exports(), alias (+27 more)
...
Cohesion: 0.07
Nodes (28): Any, Column, _tenant_identity_columns(), _timestamps(), upgrade(), Any, Column, _timestamps() (+20 more)

### Community 43 - "Password Hashing and Verification"
Cohesion: 0.13
Nodes (27): hash_password(), password_needs_rehash(), password_violations(), Path, verify_password(), _weak_passwords(), AuthResult, _challenge_digest() (+19 more)

### Community 44 - "Prompt Test Job Service"
Cohesion: 0.10
Nodes (19): ProfileCallLimiter, PromptTestAuthorizer, PromptTestRetry, PromptTestStore, datetime, Protocol, RuntimeError, UUID (+11 more)

### Community 45 - "Architecture Decision Records"
Cohesion: 0.11
Nodes (37): ADR-0002 独立 Web/API/Worker 模块化单体, background_job 权威任务状态机, ADR-0003 PostgreSQL 权威任务状态 + Dramatiq/Redis, ADR-0004 同源 Cookie 认证, 提示词草稿/发布/回滚生命周期, ADR-0005 AI 供应商中立与提示词系统, ADR-0006 固定 Word 模板导出边界, ADR-0007 Caddy/Compose/Secrets（已被取代） (+29 more)
...
Cohesion: 0.13
Nodes (18): AiGenerationResultRecord, AiGenerationResultRepository, _json_object(), _optional_uuid(), Any, datetime, 同园隔离的 AI 生成结果 Repository。, 将同园到期预览条件收敛为 expired，不修改结果正文或决策字段。 (+10 more)
...
Cohesion: 0.09
Nodes (27): Client, AgentProviderError, _finish_reason(), _parse_tool_call(), _plain_json(), Any, BaseTransport, Response (+19 more)
...
Cohesion: 0.16
Nodes (24): CountingClient, _executor(), Any, datetime, LogCaptureFixture, MonkeyPatch, TestClient, UUID (+16 more)
...
Cohesion: 0.10
Nodes (24): build_test_broker(), 生产 Redis 与确定性测试消息代理装配。, JobMessage, Redis 中唯一允许传递的最小任务消息。, StubBroker, _ai_actor(), FakeRunner, FakeScopeResolver (+16 more)
...
Cohesion: 0.17
Nodes (30): clear_prompt_tests(), create_prompt_test(), _definition(), get_prompt(), get_prompt_test(), get_prompt_version(), list_prompt_tests(), list_prompt_versions() (+22 more)
...
Cohesion: 0.09
Nodes (30): Agent Confirmed WRITE Phase, FR-033: Single Agent at Application Layer, FR-034: Tool-only Access, FR-035: Minimal Context, FR-036: READ/DRAFT Zero Write, FR-037: Patch and Confirmation, FR-038: Audit and Transactional WRITE, FR-039: Provider Port (+22 more)

### Community 66 - "Lesson Plan Source Service"
Cohesion: 0.19
Nodes (11): lesson_plan_source_service(), LessonPlanSourceDocxPreviewRecord, LessonPlanSourceRecord, LessonPlanSourceRepository, LessonPlanSourceService, LessonPlanRepository, UUID, 保留可显示文件名，但绝不保存路径、控制字符或绝对位置。 (+3 more)
...
Cohesion: 0.25
Nodes (26): _insert_job(), _insert_other_tenant_plan(), _insert_result(), _native_url(), _provision_dependencies(), TestClient, UUID, _result_values() (+18 more)
...
Cohesion: 0.11
Nodes (18): UUID, UUID, 仅投递 job_id 的提示词测试分发边界。, Dispatcher, Protocol, AiGenerationAuditMetadata, AuditEventReference, IdentityAuditMetadata (+10 more)
...
Cohesion: 0.19
Nodes (24): FastAPI, ActorFixture, prompt_admin_client(), TestClient, test_admin_creates_updates_publishes_and_restores_without_mutating_history(), test_draft_save_and_publish_use_the_same_strict_parser(), test_published_draft_id_is_never_reused_for_the_next_draft(), test_system_catalog_is_seeded_read_only_and_business_effective() (+16 more)
...
Cohesion: 0.14
Nodes (13): QDateEdit, BaseException, safe_exception_summary(), BaseException, user_error_message(), Slice 1 结构化一日活动计划编辑页。, build_first_run_daily_plan_window(), build_first_run_page() (+5 more)
...
Cohesion: 0.09
Nodes (6): Alembic 迁移, Any, Column, _timestamps(), upgrade(), 桌面 SQLite 表元数据；Schema 只由独立 Alembic 链创建。
...
Cohesion: 0.24
Nodes (17): MonkeyPatch, RuntimeError, _create_verified_protective_copy(), MigrationProtectionError, Path, _read_current_revision(), _sha256_file(), upgrade_database() (+9 more)
...
Cohesion: 0.15
Nodes (12): ai_adoption_service(), AiAdoptionService, _native_url(), datetime, PlanContentV1, ai_result_model(), BaseModel, 按冻结的 Schema 代码取得结果模型。 (+4 more)

### Community 96 - "AI Model Profile Tests"
Cohesion: 0.20
Nodes (18): ai_model_service(), ai_admin_client(), _profile_payload(), Any, TestClient, _resolver(), test_admin_creates_write_only_masked_profile_and_cannot_read_key(), test_call_fields_increment_revision_but_display_and_limits_do_not() (+10 more)
...
Cohesion: 0.22
Nodes (12): build_read_draft_registry(), _closed_schema(), _descriptor(), _draft_arguments_match(), _output_schema_for(), RuntimeError, Slice 2B 固定 READ/DRAFT Tool registry。, RegisteredTool (+4 more)
...
Cohesion: 0.15
Nodes (10): ColorScheme, ResolvedTheme, ThemePreference, _setup_complete(), _validated_theme(), desktop_stylesheet(), ThemePreference, 由同一组语义令牌派生的桌面浅色与深色主题。 (+2 more)
...
### Community 129 - "AI Task Schema Validation"
Cohesion: 0.25
...
Cohesion: 0.23
Nodes (10): activity_date_text(), CalendarEvaluation, _chinese_number(), date, season_for(), teaching_week(), TeachingWeek, test_date_and_season_text_are_deterministic() (+2 more)
...
Cohesion: 0.33
Nodes (10): _completed_preview(), _PartiallyFailingMaintenanceRepository, datetime, LogCaptureFixture, MonkeyPatch, TestClient, UUID, test_cleanup_clears_adopted_immediately_and_terminal_content_after_thirty_days() (+2 more)
...
Cohesion: 0.46
Nodes (7): _insert_batch(), Any, TestClient, UUID, _repository(), test_batch_projection_is_derived_from_exactly_four_children_without_parent_write(), test_batch_projection_is_tenant_scoped_and_requires_the_frozen_four_child_shape()
...
### Community 190 - "Group Activity AI Import"
Cohesion: 0.33
...
### Community 195 - "Agent Runtime Values Tests"
Cohesion: 0.48
...
### Community 207 - "GUI Prototype Query"
Cohesion: 0.40
...
Cohesion: 0.50
Nodes (4): _is_sensitive_key(), Any, redact_for_log(), test_log_redaction_removes_content_and_credentials_recursively()

### Community 213 - "AI Key Rotation CLI"
Cohesion: 0.60
...
Cohesion: 0.50
Nodes (4): Desktop Non-Windows Blockers Evidence, Desktop Slice 2A Acceptance Evidence, Desktop Slice 2B Acceptance Evidence, Desktop Slice 2B Windows Checklist
...
Cohesion: 0.50
Nodes (4): main(), Path, PlanContentV1, _snapshot()

### Community 224 - "Authenticated Session Identity"
Cohesion: 0.67
...
## Knowledge Gaps
- **363 isolated node(s):** `check-prerequisites.sh script`, `common.sh script`, `create-new-feature.sh script`, `setup-plan.sh script`, `setup-tasks.sh script` (+358 more)
