...
## Summary
- 5333 nodes · 15230 edges · 297 communities (245 shown, 52 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 1492 edges (avg confidence: 0.57)
- Token cost: 17,957 input · 27,327 output

## Graph Freshness
- Built from commit: `4215ca72`
- Run `git rev-parse HEAD` and compare to check if the graph is stale.
- Run `graphify update .` after code changes (no API cost).

## Community Hubs (Navigation)
- AI Model Service
- AI Generation Job Results
...
- Reflection and Audit Service
- Prompt Schema Catalog
- Authentication API Routes
- Database Models and Migrations
- Daily Plan Export Rendering
- Auth Test Helpers
- Database Migration Scripts
- Settings Domain Views
- AI Job Execution
- Identity Contracts
...
- WebAuthn Auth Tests
- Admin Init CLI
- Design and Audit Documents
- AI Generation Adoption
- AI Settings Repository
- AI Generation Tests
- Desktop Daily Plan Flow
...
- Browser Auth Smoke Tests
- Teacherplan Renderer Implementation
...
- AI Job Retry Tests
- Prompt Test Store
- Health Dependency Wiring
- Provider-Neutral AI Client
- Developer Handoff Notes
- Backup Auth Tests
- Export Section Rules
- AI Runtime Adapter Tests
- Backup Auth Isolation Tests
- Backup Maintenance Tests
- AI Client URL Policy
- AI Generation Backend Modules
- AI Task Schema Tests
- Shell Script Utilities
- AI Preview Lifecycle Tests
- Test Isolation Configuration
- Test Database Profile Tests
- Log Redaction
...
- Test Numbering Correction
- Feature Branch Script
- Rotate AI Keys CLI
- Lesson Calendar Semantics
- Manual Plan Editor Smoke
- Lesson Plan Contract
- Calendar Fixture
- Clock Fixture
- Job Broker Fixture
- Prompt Test Schema Rendering
- Lease Expiry Helper
...
- ADR Decision Query
- SQLAlchemy Alembic Foundations
- SecLists Weak Passwords Notice
- Backend API Worker Capabilities
- Shared Data Contracts
- Prerequisites Check Script
- Setup Plan Script
- Setup Tasks Script
- OpenAI Compatible AI Adapter
- Desktop SQLite Alembic Migrations
- PySide6 Qt Widgets UI
- NiceGUI Web BFF Tests
- Batch Export UI Prototype
...
- Validation Iteration 6/7
- Slice 1 Offline Windows Acceptance
- First Launch Setup Scenario
- AI Domain Models Task
- Credentials Boundary Task
- AI Client Prompts Task
- AI Migration Protection Task
- AI Generation App Task
- AI Settings UI Task
- Assemble AI App Task
- AI Acceptance Testing Task
- Fixed Word Template
- Date Utilities
...
- **Desktop Slice 2A Acceptance Evidence Process** — docs_implementation-evidence_desktop-slice-2a-acceptance_document, docs_implementation-evidence_desktop-slice-2a-acceptance_test_suite, docs_implementation-evidence_desktop-slice-2a-acceptance_migration_0002, docs_implementation-evidence_desktop-slice-2a-acceptance_graphify [INFERRED 0.75]
...
### Community 3 - "App Bootstrap Service"
Cohesion: 0.05
Nodes (74): Engine, BootstrapService, RuntimeError, StartupError, StartupState, _apply_sqlite_pragmas(), connect_sqlite(), create_session_factory() (+66 more)

### Community 4 - "DOCX Text Extraction"
Cohesion: 0.07
...
### Community 5 - "Identity Authentication Service"
Cohesion: 0.10
Nodes (26): AuditRepository, ChallengePurpose, StrEnum, AuthResult, _challenge_digest(), _client_challenge(), _decode_base64url(), IdentityError (+18 more)

### Community 6 - "AI Runtime Adapter"
Cohesion: 0.06
Nodes (44): ProviderNeutralAiClient, BaseTransport, Resolver, ProgressReporter, ProviderNeutralAiClient, _AiRuntimeAdapter, _BatchOutcome, create_desktop_window() (+36 more)

### Community 7 - "Export Repository"
Cohesion: 0.05
...
### Community 8 - "Lesson Plan Service"
Cohesion: 0.05
Nodes (41): Self, AdoptionCandidate, LessonPlanEditorState, LessonPlanError, LessonPlanRepositoryPort, LessonPlanService, date, PlanContentV1 (+33 more)

### Community 9 - "Desktop UI Observability"
Cohesion: 0.04
Nodes (42): ColorScheme, QCloseEvent, QDateEdit, QLabel, QScrollArea, ResolvedTheme, TaskProgress, _is_sensitive_key() (+34 more)

### Community 10 - "System Architecture Dependencies"
Cohesion: 0.05
...
### Community 11 - "Identity Credential Repository"
Cohesion: 0.06
...
### Community 12 - "AI Jobs API Routes"
Cohesion: 0.07
...
### Community 13 - "AI Generation Domain Schemas"
Cohesion: 0.05
Nodes (59): AreaGameResult, build_generation_input(), canonical_json_sha256(), _ClosedResult, DailyReflectionResult, merge_section_result(), MorningActivityResult, MorningTalkResult (+51 more)

### Community 14 - "System Architecture Modules"
Cohesion: 0.06
Nodes (75): ADR-0010 Identity Rewrite, ADR-0011 Password+TOTP Backup, API Application, API Dependencies, API OpenAPI Generation, Auth API Router, Exports API Router, Web API Client (+67 more)

### Community 15 - "Database Migration Tests"
Cohesion: 0.05
Nodes (59): TeacherInput, migrated_database(), MonkeyPatch, test_identity_migration_creates_tables_extension_and_role_seeds(), test_identity_migration_is_idempotent(), MonkeyPatch, settings_database(), test_age_group_seed_is_fixed_and_idempotent() (+51 more)

### Community 16 - "AI Job Worker Actors"
Cohesion: 0.08
...
### Community 17 - "Settings Management API"
Cohesion: 0.10
...
### Community 18 - "Reflection and Audit Service"
Cohesion: 0.07
Nodes (40): reflection_generation_service(), append_ai_event(), Any, UUID, UUID, ExportDownload, Word 导出创建、历史、详情与实时授权下载用例。, Broker (+32 more)

### Community 19 - "Prompt Schema Catalog"
Cohesion: 0.18
Nodes (50): PlanContentV1, EditableContent, PromptSpec, BaseModel, 固定提示词目录、输入与结果 Schema 路由。, _spec(), AiAreaGame, AiDailyReflection (+42 more)

### Community 20 - "Authentication API Routes"
Cohesion: 0.16
...
### Community 21 - "Database Models and Migrations"
Cohesion: 0.09
...
### Community 22 - "Daily Plan Export Rendering"
Cohesion: 0.09
Nodes (33): CancellationToken, ErrorCode, StrEnum, DailyPlanExportSnapshot, DayRenderer, ExportError, ExportResult, ExportService (+25 more)

### Community 23 - "Auth Test Helpers"
Cohesion: 0.09
Nodes (37): current_session(), AuthenticatedSessionDependency, FastAPI, admin_client(), passkey_client(), MonkeyPatch, TestClient, 通过 FastAPI 身份依赖注入建立已 step-up 管理员，不借用密码登录。 (+29 more)

### Community 24 - "Database Migration Scripts"
Cohesion: 0.05
Nodes (26): Alembic 迁移, Any, Column, _timestamps(), upgrade(), Any, Column, _timestamps() (+18 more)

### Community 25 - "Settings Domain Views"
Cohesion: 0.08
Nodes (21): CursorResult, DatabaseSource, _areas(), _class_view(), ClassView, KindergartenView, AbstractContextManager, date (+13 more)

### Community 26 - "AI Job Execution"
Cohesion: 0.09
Nodes (25): AiClientError, RuntimeError, AiJobAuthorizer, AI 生成任务的冻结上下文执行器与 PostgreSQL 状态适配器。, CurrentModelCallProfile, ProfileCallLimiter, PromptTestAuthorizer, PromptTestExecutionContext (+17 more)

### Community 27 - "Identity Contracts"
Cohesion: 0.07
...
### Community 28 - "Development Workflow Rules"
Cohesion: 0.12
...
### Community 29 - "Prompt Repository and Tests"
Cohesion: 0.14
...
### Community 30 - "WebAuthn Auth Tests"
Cohesion: 0.11
...
### Community 32 - "Design and Audit Documents"
Cohesion: 0.10
Nodes (46): CSRF & Origin Verification, Data Model Design, Database Schema Design, System Architecture, main Branch (stable release baseline), Combined Audit Conclusion (Q1–Q26), M0-G1 Model & Contract Alignment, M0-G2 Template Instructions Alignment (+38 more)

### Community 33 - "AI Generation Adoption"
Cohesion: 0.09
Nodes (16): AdoptedContent, AdoptionTransaction, AiGenerationCoordinator, AiGenerationError, AiPreviewStore, GenerationRuntime, _Operation, AbstractContextManager (+8 more)

### Community 34 - "AI Settings Repository"
Cohesion: 0.08
Nodes (17): AiSettingsError, AiSettingsRepository, AiSettingsTransaction, CredentialPort, AbstractContextManager, Any, Protocol, RuntimeError (+9 more)

### Community 35 - "AI Generation Tests"
Cohesion: 0.13
...
### Community 36 - "Desktop Daily Plan Flow"
Cohesion: 0.12
Nodes (25): date, DesktopSettingsContext, MonkeyPatch, _build(), _child(), FakeDesktopServices, Any, CommandResult (+17 more)

### Community 37 - "Architecture Decision Records"
Cohesion: 0.10
...
### Community 38 - "AI Job Execution Store"
Cohesion: 0.10
Nodes (18): AiExecutionContext, AiJobStore, AiJobStoreProtocol, _log_sanitized_exception(), Any, datetime, Exception, Protocol (+10 more)

### Community 39 - "AI Key Encryption Rotation"
Cohesion: 0.15
...
### Community 40 - "Settings Service Tests"
Cohesion: 0.09
...
### Community 41 - "AI Adoption Service"
Cohesion: 0.11
Nodes (22): ai_adoption_service(), AiAdoptionService, _native_url(), AiTaskCode, Any, datetime, JsonValue, LessonPlanRepository (+14 more)

### Community 42 - "Repository Branch Strategy"
Cohesion: 0.12
Nodes (39): codex 实现分支（待授权创建）, main 分支（docs-only 基线）, trae 实现分支（待授权创建）, 旧仓库 ywyz/kindergartenManager, 架构契约 Q13（幂等定义）, CONTEXT.md（项目上下文）, 双 Agent 独立开发协议 (已退役), 2026-07-14 编码前审查报告（Codex + Trae 收敛版） (+31 more)

### Community 43 - "Database Entity Catalog"
Cohesion: 0.08
...
### Community 46 - "Daily Plan Workspace"
Cohesion: 0.09
...
Cohesion: 0.14
Nodes (15): ai_generation_service(), ai_retry_service(), AiRetryService, _native_url(), Dispatcher, UUID, AiGenerationAcceptance, AiGenerationService (+7 more)

### Community 48 - "Desktop Runtime Bridge"
Cohesion: 0.11
Nodes (22): BackgroundTask, CancellationToken, QObject, QRunnable, CommandResult, UUID, 仍由 bridge 持有、等待线程池安全释放的 operation。, _reject_thread_bound() (+14 more)

### Community 49 - "Daily Plan Editor UI"
Cohesion: 0.11
Nodes (13): EditorKind, DailyPlanPage, FieldDefinition, _lines(), ProcessEditor, Any, DailyPlanContext, DesktopServices (+5 more)

### Community 50 - "WebAuthn Challenges"
Cohesion: 0.10
...
### Community 51 - "Identity Password Utilities"
Cohesion: 0.12
...
### Community 52 - "TOTP Secret Encryption"
Cohesion: 0.12
...
### Community 53 - "Word Export Flow Tests"
Cohesion: 0.13
...
### Community 54 - "Prompt Test API Tests"
Cohesion: 0.33
...
### Community 57 - "Export Contract Fingerprint"
Cohesion: 0.11
Nodes (29): canonical_request_fingerprint(), _normalize_scalar(), 计算覆盖路由、实际资源与语义输入的 canonical SHA-256。, _export_payload(), _job_payload(), Any, UUID, T127 固定 Word 导出公共契约 RED。 (+21 more)

### Community 58 - "Exports API Tests"
Cohesion: 0.38
Nodes (27): SimpleNamespace, provision_editable_plan_context(), date, TestClient, _complete_content(), _headers(), _native_url(), MonkeyPatch (+19 more)

### Community 59 - "TOTP Authentication Primitives"
Cohesion: 0.12
Nodes (29): identity_service(), candidate_totp_counters(), _counter(), generate_totp(), generate_totp_secret(), _hotp(), RFC 6238 TOTP 原语；持久化重放保护由 Repository 完成。, 生成认证器广泛兼容的 160 位无填充 Base32 种子。 (+21 more)

### Community 60 - "Batch Job Status Aggregation"
Cohesion: 0.14
...
### Community 63 - "Frontend BFF API Contracts"
Cohesion: 0.11
...
### Community 64 - "Authentication Rate Limiting"
Cohesion: 0.13
...
### Community 67 - "Backup Auth BFF Contracts"
Cohesion: 0.15
Nodes (22): backup_auth_api_request(), backup_login_api_request(), backup_reauthentication_api_request(), 只通过同源 BFF 访问本人备用登录端点。, 以请求正文提交两项备用因素，不把秘密放入 URL。, 为当前备用会话取得仅可新增通行密钥的短时证明。, 读取本人最近 20 条内建安全事件，不产生已读状态。, 从浏览器经同源 BFF 调用 API，并为写请求取得 CSRF token。 (+14 more)

### Community 68 - "Background Job Repository"
Cohesion: 0.21
Nodes (10): _ai_job(), AiJobRecord, _job(), JobRecord, JobRepository, Any, datetime, PostgreSQL 权威后台任务 Repository。 (+2 more)

### Community 69 - "FastAPI App Assembly"
Cohesion: 0.11
Nodes (20): _error_response(), _identity_error_response(), FastAPI, Request, UUID, FastAPI 应用装配、统一异常转换与健康端点。, _request_id(), API 请求 ID 与追踪 ID 中间件。 (+12 more)

### Community 70 - "Settings Permissions"
Cohesion: 0.33
...
### Community 71 - "Login Rate Limiting"
Cohesion: 0.17
...
### Community 72 - "Security Architecture Decisions"
Cohesion: 0.12
...
### Community 75 - "AI Preview Flow Tests"
Cohesion: 0.16
Nodes (11): CoordinatorState, PreviewView, FakeAiServices, CommandResult, OperationAccepted, QtBot, UUID, test_actual_panel_disables_duplicate_start_while_operation_runs() (+3 more)

### Community 76 - "Browser Auth Smoke Tests"
Cohesion: 0.14
...
### Community 79 - "Specs and Documentation"
Cohesion: 0.13
...
### Community 80 - "AI Result Repository"
Cohesion: 0.23
...
### Community 81 - "Daily Activity AI Prompts"
Cohesion: 0.16
...
### Community 83 - "AI Job Retry Tests"
Cohesion: 0.20
...
### Community 84 - "Prompt Test Store"
Cohesion: 0.25
Nodes (5): _native_url(), PostgresPromptTestStore, Any, datetime, UUID

### Community 85 - "Health Dependency Wiring"
Cohesion: 0.17
...
### Community 86 - "Provider-Neutral AI Client"
Cohesion: 0.15
...
### Community 89 - "Export Section Rules"
Cohesion: 0.19
...
### Community 90 - "AI Runtime Adapter Tests"
Cohesion: 0.23
Nodes (10): FrozenGenerationInput, GenerationWork, CapturingBridge, CapturingClient, MutableCredentials, MutableProviderRepository, Any, UUID (+2 more)

### Community 91 - "Backup Auth Isolation Tests"
Cohesion: 0.25
...
### Community 92 - "Backup Maintenance Tests"
Cohesion: 0.29
...
### Community 93 - "AI Client URL Policy"
Cohesion: 0.24
Nodes (13): HTTPX (外部 HTTP 客户端), _pinned_url(), Any, OpenAI 兼容、禁止重定向且错误脱敏的供应商中立客户端。, _addresses(), AiUrlPolicyError, Resolver, ValueError (+5 more)

### Community 94 - "AI Generation Backend Modules"
Cohesion: 0.13
...
### Community 95 - "AI Task Schema Tests"
Cohesion: 0.20
...
### Community 98 - "Test Isolation Configuration"
Cohesion: 0.15
...
### Community 99 - "Test Database Profile Tests"
Cohesion: 0.31
...
### Community 103 - "Agent Runtime Contract"
Cohesion: 0.13
Nodes (15): 10. 线程契约, 11. 事务与 WRITE 契约, 12. 无长期业务记忆, 13. 验证矩阵, 14. 明确非目标, 1. 目的与适用阶段, 2. 依赖与信任规则, 3. `Runtime` (+7 more)

### Community 104 - "Desktop Service Architecture"
Cohesion: 0.13
Nodes (15): 10. `ExportService`, 11. `BackupService`, 12. Qt 运行时桥接, 13. 架构契约测试, 1. 目的, 2. 依赖规则, 3. 共享结果类型, 4. `BootstrapService` (+7 more)

### Community 105 - "AI Preview Panel"
Cohesion: 0.27
Nodes (4): AiPreviewPanel, DesktopServices, QFrame, 实际教案页中的可选 AI 入口、逐栏预览与显式采用面板。

### Community 106 - "Runtime OpenAPI Contract"
Cohesion: 0.37
...
### Community 108 - "Teacher Plan Renderer"
Cohesion: 0.28
...
### Community 109 - "Web Entry Security"
Cohesion: 0.25
...
### Community 110 - "Settings UI Smoke Tests"
Cohesion: 0.24
...
### Community 111 - "Development Workflow Plan"
Cohesion: 0.24
...
### Community 112 - "Security Configuration"
Cohesion: 0.25
...
### Community 115 - "BFF Proxy Client"
Cohesion: 0.24
Nodes (11): BffResponse, proxy_request(), AsyncBaseTransport, NiceGUI 服务端 BFF 客户端的公开接缝。, 按固定 allowlist 转发请求，并保留响应原始多值头。, MonkeyPatch, test_plan_docx_preview_request_forwards_csrf_cookie_and_multipart(), test_proxy_ignores_process_proxy_environment() (+3 more)

### Community 116 - "Desktop Data Backup Security"
Cohesion: 0.15
Nodes (12): 1. 本地数据权威, 2. Schema 迁移, 3. 保存、版本与归档, 4. 凭据存储, 5. 备份包, 6. 备份与恢复流程, 7. 非同步保证, 8. 威胁与验证 (+4 more)

### Community 117 - "Desktop Architecture Decisions"
Cohesion: 0.15
...
### Community 118 - "Credential Management API"
Cohesion: 0.36
...
### Community 119 - "AI Repository Operations"
Cohesion: 0.36
...
### Community 120 - "AI Prompt Settings UI"
Cohesion: 0.19
...
### Community 122 - "Controlled Agent Runtime ADR"
Cohesion: 0.17
...
### Community 123 - "Desktop Slice 2A RED Evidence"
Cohesion: 0.24
...
### Community 124 - "Backup Package Contract"
Cohesion: 0.17
Nodes (12): 10. 验证矩阵, 1. 范围, 2. 内部完整包, 3. 一致性快照生成, 4. 加密信封, 5. 凭据存储, 6. 远程对象, 7. 轮换 (+4 more)

### Community 125 - "Settings API Contract"
Cohesion: 0.24
...
### Community 126 - "AI Prompt Repositories"
Cohesion: 0.30
...
### Community 127 - "AI Generation Service"
Cohesion: 0.48
...
### Community 128 - "OpenAPI Contract Assembly"
Cohesion: 0.29
...
### Community 132 - "Export Repository"
Cohesion: 0.55
...
### Community 133 - "AI Client Safety"
Cohesion: 0.44
...
### Community 134 - "Transaction Session Boundaries"
Cohesion: 0.27
...
### Community 135 - "Trusted BFF Client IP"
Cohesion: 0.33
...
### Community 138 - "Manual Lesson Plan US2"
Cohesion: 0.24
...
### Community 139 - "Group Activity Sources"
Cohesion: 0.49
...
### Community 140 - "Local Dev Profiles"
Cohesion: 0.27
...
### Community 141 - "Architecture Boundaries"
Cohesion: 0.40
...
### Community 142 - "Workday Calendar Service"
Cohesion: 0.29
...
### Community 143 - "Plan and Prompt Tests"
Cohesion: 0.11
Nodes (36): ActorFixture, MonkeyPatch, TestClient, test_autosave_creates_no_snapshot_and_stale_version_never_overwrites(), test_manual_save_rolls_back_content_version_snapshot_and_audit_together(), MonkeyPatch, TestClient, test_open_is_idempotent_and_list_get_save_archive_history_restore_work() (+28 more)

### Community 144 - "Target Service Architecture"
Cohesion: 0.31
...
### Community 147 - "OpenAPI Document Contract"
Cohesion: 0.36
...
### Community 148 - "Secret Encryption Envelope"
Cohesion: 0.39
...
### Community 149 - "API Startup Security"
Cohesion: 0.32
...
### Community 151 - "Agent Runtime Decisions"
Cohesion: 0.25
...
### Community 158 - "AI Model URL Policy"
Cohesion: 0.57
...
### Community 159 - "Prompt Catalog Contract"
Cohesion: 0.43
...
### Community 160 - "Backup Auth Security Events"
Cohesion: 0.33
...
### Community 161 - "Passkey Expand Migration"
Cohesion: 0.52
Nodes (5): Any, Column, _tenant_identity_columns(), _timestamps(), upgrade()

### Community 162 - "Group Activity Import US5"
Cohesion: 0.33
...
### Community 163 - "Group Activity Add Step"
Cohesion: 0.38
...
### Community 164 - "Settings Backup Login US1"
Cohesion: 0.29
...
### Community 166 - "Service Architecture Roadmap"
Cohesion: 0.60
Nodes (6): 共同实施路线, 当前仓库与分支状态, Web、API 与 Worker 服务边界, 目标服务架构, 查询记录 2026-07-11 02:19：接下来需要生成什么文件, 查询记录 2026-07-11 02:42：系统架构文档要素

### Community 167 - "Slice 2A Acceptance"
Cohesion: 0.33
Nodes (6): Desktop Slice 2A Local Acceptance Evidence, Graphify Verification Tool, GitHub Issue #19, Migration to 0002_desktop_ai, Fixed GREEN Review Process, Desktop Slice 2A Test Suite

### Community 168 - "Slice 1 Review Remediation"
Cohesion: 0.40
...
### Community 169 - "Identity Audit Migration"
Cohesion: 0.53
Nodes (4): Column, datetime, _timestamps(), upgrade()

### Community 170 - "Word Export US6"
Cohesion: 0.33
...
### Community 172 - "TOTP Authentication"
Cohesion: 0.53
...
### Community 173 - "Slice 1 Windows Acceptance"
Cohesion: 0.40
...
### Community 179 - "Acceptance Timing Clarification"
Cohesion: 0.40
...
### Community 180 - "Test Numbering Correction"
Cohesion: 0.40
...
### Community 182 - "Rotate AI Keys CLI"
Cohesion: 0.60
...
### Community 183 - "Lesson Calendar Semantics"
Cohesion: 0.70
...
### Community 184 - "Manual Plan Editor Smoke"
Cohesion: 0.50
...
### Community 186 - "Lesson Plan Contract"
Cohesion: 0.83
...
## Knowledge Gaps
- **354 isolated node(s):** `check-prerequisites.sh script`, `common.sh script`, `create-new-feature.sh script`, `setup-plan.sh script`, `setup-tasks.sh script` (+349 more)
