...
- 生产部署设计。ADR-0010 已冻结受限公网、Web/BFF 唯一公网应用入口、WebAuthn 与账号恢复边界；根据 ADR-0009，反向代理产品、生产拓扑、密钥托管、备份恢复和上线流程仍在全部功能完成后另行复审。
...
- 已确认的 [`docs/security/threat-model.md`](security/threat-model.md) 及 ADR-0010。
...
- WebAuthn 通行密钥是唯一常规登录方式；账号恢复采用离线恢复码加人工核验。
