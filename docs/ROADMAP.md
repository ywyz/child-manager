...
现为 `in_progress`，T087–T103 已完成，继续遵守 `0006_lesson_plans → 0007_ai_prompts_jobs →
0008_ai_generation_results → 0009_group_activity_sources` 迁移链。M6 Issue 必须固定引用
不可移动 docs 基线，并保持 US4 T087–T110 先于 US5 T111–T126；当前下一项为 T104，
批量/单栏受理、任务轮询和预览生命周期薄路由验收保留给 T107。
...
| M6 | `in_progress` | [#11](https://github.com/ywyz/child-manager/issues/11) 覆盖 T087–T126；固定文档基线、T087–T097 RED 与 T098–T103 已完成；T103 `dev@4a9974eaa80ae1e9b0e6a15035512bbb32b6b2d1` 自有门禁为 `66 passed, 1 deselected` | 实施 T104 的直接聚合、Actor、恢复扫描和预览维护门禁；T107 前保留 API 路由级 RED |
...
M4 T062–T086、M5 T046–T061 以及 M6 T087–T103 均已完成；M6 当前下一项为 T104。共享
